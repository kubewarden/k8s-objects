...
func easyjson52fae72cEncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV19(out *jwriter.Writer, in JSONSchemaProps) {
		...
		}
		{
			...
			for v29, v30 := range in.AllOf {
				...
				if v30 == nil {
					...
					easyjson52fae72cEncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV19(out, *v30)
				}
			}
			out.RawByte(']')
		}
		...
		}
		{
			...
			for v31, v32 := range in.AnyOf {
				...
				if v32 == nil {
					...
					easyjson52fae72cEncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV19(out, *v32)
				}
			}
			out.RawByte(']')
		}
	...
	if len(in.Definitions) != 0 {
		...
		}
		{
			out.RawByte('{')
			v33First := true
			for v33Name, v33Value := range in.Definitions {
				if v33First {
					v33First = false
				} else {
					out.RawByte(',')
				...
				if v33Value == nil {
					...
					easyjson52fae72cEncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV19(out, *v33Value)
				}
			}
			out.RawByte('}')
		}
	...
	if len(in.Dependencies) != 0 {
		...
		}
		{
			out.RawByte('{')
			v34First := true
			for v34Name, v34Value := range in.Dependencies {
				if v34First {
					v34First = false
				} else {
					out.RawByte(',')
		...
		}
		{
			...
			for v37, v38 := range in.OneOf {
				...
				if v38 == nil {
					...
					easyjson52fae72cEncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV19(out, *v38)
				}
			}
			out.RawByte(']')
		}
	...
	if len(in.PatternProperties) != 0 {
		...
		}
		{
			out.RawByte('{')
			v39First := true
			for v39Name, v39Value := range in.PatternProperties {
				if v39First {
					v39First = false
				} else {
					out.RawByte(',')
				...
				if v39Value == nil {
					...
					easyjson52fae72cEncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV19(out, *v39Value)
				}
			}
			out.RawByte('}')
		}
	...
	if len(in.Properties) != 0 {
		...
		}
		{
			out.RawByte('{')
			v40First := true
			for v40Name, v40Value := range in.Properties {
				if v40First {
					v40First = false
				} else {
					out.RawByte(',')
	...
	if len(in.XKubernetesListMapKeys) != 0 {
		...
		{
			out.RawByte('[')
			for v43, v44 := range in.XKubernetesListMapKeys {
				if v43 > 0 {
					out.RawByte(',')
				}
