...
func easyjson57e69005DecodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV1(in *jlexer.Lexer, out *CustomResourceDefinitionNames) {
...
func easyjson57e69005EncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV1(out *jwriter.Writer, in CustomResourceDefinitionNames) {
	out.RawByte('{')
	first := true
	_ = first
...
func (v CustomResourceDefinitionNames) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson57e69005EncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV1(&w, v)
...
func (v *CustomResourceDefinitionNames) UnmarshalJSON(data []byte) error {
	...
	easyjson57e69005DecodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *CustomResourceDefinitionNames) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson57e69005DecodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV1(l, v)
}
