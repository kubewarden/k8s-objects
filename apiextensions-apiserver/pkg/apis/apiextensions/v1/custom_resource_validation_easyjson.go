...
func easyjson508aa052DecodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV1(in *jlexer.Lexer, out *CustomResourceValidation) {
	...
	for !in.IsDelim('}') {
		...
		case "openAPIV3Schema":
			if in.IsNull() {
				...
				easyjson508aa052DecodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV11(in, out.OpenAPIV3Schema)
			}
		default:
			in.SkipRecursive()
		}
...
func easyjson508aa052EncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV1(out *jwriter.Writer, in CustomResourceValidation) {
	out.RawByte('{')
	first := true
	_ = first
	if in.OpenAPIV3Schema != nil {
		...
		easyjson508aa052EncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV11(out, *in.OpenAPIV3Schema)
	}
	out.RawByte('}')
}
...
func (v CustomResourceValidation) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson508aa052EncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV1(&w, v)
...
func (v *CustomResourceValidation) UnmarshalJSON(data []byte) error {
	...
	easyjson508aa052DecodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *CustomResourceValidation) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson508aa052DecodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV1(l, v)
}
func easyjson508aa052DecodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV11(in *jlexer.Lexer, out *JSONSchemaProps) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjson508aa052DecodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV11(in, v1)
					}
			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjson508aa052DecodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV11(in, v2)
					}
			...
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					...
					if in.IsNull() {
						...
						easyjson508aa052DecodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV11(in, v3)
					}
		...
		case "externalDocs":
			if in.IsNull() {
				...
				easyjson508aa052DecodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV12(in, out.ExternalDocs)
			}
		case "format":
		...
		case "not":
			if in.IsNull() {
				...
				easyjson508aa052DecodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV11(in, out.Not)
			}
		case "nullable":
			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjson508aa052DecodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV11(in, v6)
					}
			...
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					...
					if in.IsNull() {
						...
						easyjson508aa052DecodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV11(in, v7)
					}
			...
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					...
					if in.IsNull() {
						...
						easyjson508aa052DecodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV11(in, v8)
					}
			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjson508aa052DecodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV13(in, v11)
					}
...
func easyjson508aa052EncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV11(out *jwriter.Writer, in JSONSchemaProps) {
	out.RawByte('{')
	first := true
	_ = first
	if in.DollarRef != "" {
		...
		}
		{
			...
			for v12, v13 := range in.AllOf {
				...
				if v13 == nil {
					...
					easyjson508aa052EncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV11(out, *v13)
				}
			}
			out.RawByte(']')
		}
		...
		}
		{
			...
			for v14, v15 := range in.AnyOf {
				...
				if v15 == nil {
					...
					easyjson508aa052EncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV11(out, *v15)
				}
			}
			out.RawByte(']')
		}
		...
		}
		{
			...
			for v16Name, v16Value := range in.Definitions {
				...
				if v16Value == nil {
					...
					easyjson508aa052EncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV11(out, *v16Value)
				}
			}
			out.RawByte('}')
		}
	...
	if in.ExternalDocs != nil {
		...
		easyjson508aa052EncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV12(out, *in.ExternalDocs)
	}
	if in.Format != "" {
	...
	if in.Not != nil {
		...
		easyjson508aa052EncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV11(out, *in.Not)
	}
	if in.Nullable {
		...
		}
		{
			...
			for v20, v21 := range in.OneOf {
				...
				if v21 == nil {
					...
					easyjson508aa052EncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV11(out, *v21)
				}
			}
			out.RawByte(']')
		}
		...
		}
		{
			...
			for v22Name, v22Value := range in.PatternProperties {
				...
				if v22Value == nil {
					...
					easyjson508aa052EncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV11(out, *v22Value)
				}
			}
			out.RawByte('}')
		}
		...
		}
		{
			...
			for v23Name, v23Value := range in.Properties {
				...
				if v23Value == nil {
					...
					easyjson508aa052EncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV11(out, *v23Value)
				}
			}
			out.RawByte('}')
		}
		...
		}
		{
			...
			for v28, v29 := range in.XKubernetesValidations {
				...
				if v29 == nil {
					...
					easyjson508aa052EncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV13(out, *v29)
				}
			}
			out.RawByte(']')
		}
...
func easyjson508aa052DecodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV13(in *jlexer.Lexer, out *ValidationRule) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson508aa052EncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV13(out *jwriter.Writer, in ValidationRule) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Message != "" {
...
func easyjson508aa052DecodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV12(in *jlexer.Lexer, out *ExternalDocumentation) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson508aa052EncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV12(out *jwriter.Writer, in ExternalDocumentation) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Description != "" {
