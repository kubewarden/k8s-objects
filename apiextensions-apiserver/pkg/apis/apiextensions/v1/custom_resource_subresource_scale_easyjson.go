...
func easyjsonD9b34a96DecodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV1(in *jlexer.Lexer, out *CustomResourceSubresourceScale) {
...
func easyjsonD9b34a96EncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV1(out *jwriter.Writer, in CustomResourceSubresourceScale) {
	out.RawByte('{')
	first := true
	_ = first
...
func (v CustomResourceSubresourceScale) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonD9b34a96EncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV1(&w, v)
...
func (v *CustomResourceSubresourceScale) UnmarshalJSON(data []byte) error {
	...
	easyjsonD9b34a96DecodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *CustomResourceSubresourceScale) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonD9b34a96DecodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV1(l, v)
}
