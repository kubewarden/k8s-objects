	...
	for !in.IsDelim('}') {
		...
		case "x-kubernetes-validations":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v14 *ValidationRule
					if in.IsNull() {
						in.Skip()
						v14 = nil
					} else {
						if v14 == nil {
							v14 = new(ValidationRule)
						}
						easyjson81183069DecodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV16(in, v14)
					}
					out.XKubernetesValidations = append(out.XKubernetesValidations, v14)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjson81183069EncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV14(out *jwriter.Writer, in JSONSchemaProps) {
		...
		}
		{
			...
			for v15, v16 := range in.AllOf {
				...
				if v16 == nil {
					...
					easyjson81183069EncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV14(out, *v16)
				}
			}
			out.RawByte(']')
		}
		...
		}
		{
			...
			for v17, v18 := range in.AnyOf {
				...
				if v18 == nil {
					...
					easyjson81183069EncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV14(out, *v18)
				}
			}
			out.RawByte(']')
		}
	...
	if len(in.Definitions) != 0 {
		...
		}
		{
			out.RawByte('{')
			v19First := true
			for v19Name, v19Value := range in.Definitions {
				if v19First {
					v19First = false
				} else {
					out.RawByte(',')
				...
				if v19Value == nil {
					...
					easyjson81183069EncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV14(out, *v19Value)
				}
			}
			out.RawByte('}')
		}
	...
	if len(in.Dependencies) != 0 {
		...
		}
		{
			out.RawByte('{')
			v20First := true
			for v20Name, v20Value := range in.Dependencies {
				if v20First {
					v20First = false
				} else {
					out.RawByte(',')
		...
		}
		{
			...
			for v23, v24 := range in.OneOf {
				...
				if v24 == nil {
					...
					easyjson81183069EncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV14(out, *v24)
				}
			}
			out.RawByte(']')
		}
	...
	if len(in.PatternProperties) != 0 {
		...
		}
		{
			out.RawByte('{')
			v25First := true
			for v25Name, v25Value := range in.PatternProperties {
				if v25First {
					v25First = false
				} else {
					out.RawByte(',')
	...
	if len(in.Properties) != 0 {
		...
		}
		{
			out.RawByte('{')
			v26First := true
			for v26Name, v26Value := range in.Properties {
				if v26First {
					v26First = false
				} else {
					out.RawByte(',')
				...
				if v26Value == nil {
					...
					easyjson81183069EncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV14(out, *v26Value)
				}
			}
			out.RawByte('}')
		}
	...
	if len(in.XKubernetesListMapKeys) != 0 {
		...
		{
			out.RawByte('[')
			for v29, v30 := range in.XKubernetesListMapKeys {
				if v29 > 0 {
					out.RawByte(',')
				}
	...
	if len(in.XKubernetesValidations) != 0 {
		...
		{
			out.RawByte('[')
			for v31, v32 := range in.XKubernetesValidations {
				if v31 > 0 {
					out.RawByte(',')
				}
				if v32 == nil {
					...
					easyjson81183069EncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV16(out, *v32)
				}
			}
			out.RawByte(']')
		}
...
func easyjson81183069DecodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV16(in *jlexer.Lexer, out *ValidationRule) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson81183069EncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV16(out *jwriter.Writer, in ValidationRule) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Message != "" {
