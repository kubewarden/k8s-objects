		...
		case "dependencies":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					key := string(in.String())
					in.WantColon()
					var v10 JSONSchemaPropsOrStringArray
...
func easyjson60898210EncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV15(out *jwriter.Writer, in JSONSchemaProps) {
		...
		if in.AllOf == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v17, v18 := range in.AllOf {
				...
				if v18 == nil {
					...
					easyjson60898210EncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV15(out, *v18)
				}
			}
			out.RawByte(']')
		}
		...
		if in.AnyOf == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v19, v20 := range in.AnyOf {
				...
				if v20 == nil {
					...
					easyjson60898210EncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV15(out, *v20)
				}
			}
			out.RawByte(']')
		}
	...
	if len(in.Definitions) != 0 {
		...
		out.RawString(prefix)
		{
			out.RawByte('{')
			v21First := true
			for v21Name, v21Value := range in.Definitions {
				if v21First {
					v21First = false
				} else {
					out.RawByte(',')
				...
				out.RawByte(':')
				easyjson60898210EncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV15(out, v21Value)
			}
			out.RawByte('}')
		}
	}
	if len(in.Dependencies) != 0 {
		...
		out.RawString(prefix)
		{
			out.RawByte('{')
			v22First := true
			for v22Name, v22Value := range in.Dependencies {
				if v22First {
					v22First = false
				} else {
					out.RawByte(',')
		...
		if in.OneOf == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v25, v26 := range in.OneOf {
				...
				if v26 == nil {
					...
					easyjson60898210EncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV15(out, *v26)
				}
			}
			out.RawByte(']')
		}
	...
	if len(in.PatternProperties) != 0 {
		...
		out.RawString(prefix)
		{
			out.RawByte('{')
			v27First := true
			for v27Name, v27Value := range in.PatternProperties {
				if v27First {
					v27First = false
				} else {
					out.RawByte(',')
				...
				out.RawByte(':')
				easyjson60898210EncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV15(out, v27Value)
			}
			out.RawByte('}')
		}
	}
	...
	}
	{
		...
		if in.XKubernetesListMapKeys == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v31, v32 := range in.XKubernetesListMapKeys {
				if v31 > 0 {
					out.RawByte(',')
				}
