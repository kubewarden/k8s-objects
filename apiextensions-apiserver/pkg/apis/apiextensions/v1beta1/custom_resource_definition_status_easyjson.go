...
func easyjsonCe444ffDecodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV1beta1(in *jlexer.Lexer, out *CustomResourceDefinitionStatus) {
...
func easyjsonCe444ffEncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV1beta1(out *jwriter.Writer, in CustomResourceDefinitionStatus) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v CustomResourceDefinitionStatus) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonCe444ffEncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV1beta1(&w, v)
...
func (v *CustomResourceDefinitionStatus) UnmarshalJSON(data []byte) error {
	...
	easyjsonCe444ffDecodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV1beta1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *CustomResourceDefinitionStatus) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonCe444ffDecodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV1beta1(l, v)
}
