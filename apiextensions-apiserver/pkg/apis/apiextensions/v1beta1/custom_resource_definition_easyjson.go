		...
		case "dependencies":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					key := string(in.String())
					in.WantColon()
					var v25 JSONSchemaPropsOrStringArray
...
func easyjson52fae72cEncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV1beta18(out *jwriter.Writer, in JSONSchemaProps) {
		...
		if in.AllOf == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v31, v32 := range in.AllOf {
				...
				if v32 == nil {
					...
					easyjson52fae72cEncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV1beta18(out, *v32)
				}
			}
			out.RawByte(']')
		}
		...
		if in.AnyOf == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v33, v34 := range in.AnyOf {
				...
				if v34 == nil {
					...
					easyjson52fae72cEncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV1beta18(out, *v34)
				}
			}
			out.RawByte(']')
		}
	...
	if len(in.Definitions) != 0 {
		...
		out.RawString(prefix)
		{
			out.RawByte('{')
			v35First := true
			for v35Name, v35Value := range in.Definitions {
				if v35First {
					v35First = false
				} else {
					out.RawByte(',')
				...
				out.RawByte(':')
				easyjson52fae72cEncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV1beta18(out, v35Value)
			}
			out.RawByte('}')
		}
	}
	if len(in.Dependencies) != 0 {
		...
		out.RawString(prefix)
		{
			out.RawByte('{')
			v36First := true
			for v36Name, v36Value := range in.Dependencies {
				if v36First {
					v36First = false
				} else {
					out.RawByte(',')
		...
		if in.OneOf == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v39, v40 := range in.OneOf {
				...
				if v40 == nil {
					...
					easyjson52fae72cEncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV1beta18(out, *v40)
				}
			}
			out.RawByte(']')
		}
	...
	if len(in.PatternProperties) != 0 {
		...
		out.RawString(prefix)
		{
			out.RawByte('{')
			v41First := true
			for v41Name, v41Value := range in.PatternProperties {
				if v41First {
					v41First = false
				} else {
					out.RawByte(',')
				...
				out.RawByte(':')
				easyjson52fae72cEncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV1beta18(out, v41Value)
			}
			out.RawByte('}')
		}
	}
	if len(in.Properties) != 0 {
		...
		out.RawString(prefix)
		{
			out.RawByte('{')
			v42First := true
			for v42Name, v42Value := range in.Properties {
				if v42First {
					v42First = false
				} else {
					out.RawByte(',')
