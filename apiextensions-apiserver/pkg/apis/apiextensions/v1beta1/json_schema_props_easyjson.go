...
func easyjson51a8e721DecodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV1beta1(in *jlexer.Lexer, out *JSONSchemaProps) {
...
func easyjson51a8e721EncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV1beta1(out *jwriter.Writer, in JSONSchemaProps) {
	out.RawByte('{')
	first := true
	_ = first
	if in.DollarRef != "" {
...
func (v JSONSchemaProps) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson51a8e721EncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV1beta1(&w, v)
...
func (v *JSONSchemaProps) UnmarshalJSON(data []byte) error {
	...
	easyjson51a8e721DecodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV1beta1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *JSONSchemaProps) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson51a8e721DecodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV1beta1(l, v)
}
