		...
		}
		{
			...
			for v11, v12 := range in.AllOf {
				...
				if v12 == nil {
					...
					easyjson508aa052EncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV1beta11(out, *v12)
				}
			}
			out.RawByte(']')
		}
		...
		}
		{
			...
			for v13, v14 := range in.AnyOf {
				...
				if v14 == nil {
					...
					easyjson508aa052EncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV1beta11(out, *v14)
				}
			}
			out.RawByte(']')
		}
		...
		}
		{
			...
			for v15Name, v15Value := range in.Definitions {
				...
				if v15Value == nil {
					...
					easyjson508aa052EncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV1beta11(out, *v15Value)
				}
			}
			out.RawByte('}')
		}
		...
		}
		{
			...
			for v19, v20 := range in.OneOf {
				...
				if v20 == nil {
					...
					easyjson508aa052EncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV1beta11(out, *v20)
				}
			}
			out.RawByte(']')
		}
		...
		}
		{
			...
			for v22Name, v22Value := range in.Properties {
				...
				if v22Value == nil {
					...
					easyjson508aa052EncodeGithubComKubewardenK8sObjectsApiextensionsApiserverPkgApisApiextensionsV1beta11(out, *v22Value)
				}
			}
			out.RawByte('}')
		}
