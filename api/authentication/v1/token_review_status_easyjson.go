...
func easyjson78c93ed9DecodeGithubComKubewardenK8sObjectsApiAuthenticationV1(in *jlexer.Lexer, out *TokenReviewStatus) {
	...
	for !in.IsDelim('}') {
		...
		case "user":
			if in.IsNull() {
				...
				easyjson78c93ed9DecodeGithubComKubewardenK8sObjectsApiAuthenticationV11(in, out.User)
			}
		default:
			in.SkipRecursive()
		}
...
func easyjson78c93ed9EncodeGithubComKubewardenK8sObjectsApiAuthenticationV1(out *jwriter.Writer, in TokenReviewStatus) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v TokenReviewStatus) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson78c93ed9EncodeGithubComKubewardenK8sObjectsApiAuthenticationV1(&w, v)
...
func (v *TokenReviewStatus) UnmarshalJSON(data []byte) error {
	...
	easyjson78c93ed9DecodeGithubComKubewardenK8sObjectsApiAuthenticationV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *TokenReviewStatus) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson78c93ed9DecodeGithubComKubewardenK8sObjectsApiAuthenticationV1(l, v)
}
func easyjson78c93ed9DecodeGithubComKubewardenK8sObjectsApiAuthenticationV11(in *jlexer.Lexer, out *UserInfo) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson78c93ed9EncodeGithubComKubewardenK8sObjectsApiAuthenticationV11(out *jwriter.Writer, in UserInfo) {
	out.RawByte('{')
	first := true
	_ = first
	if len(in.Extra) != 0 {
