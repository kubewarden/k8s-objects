...
func easyjson658ab631DecodeGithubComKubewardenK8sObjectsApiNetworkingV1beta1(in *jlexer.Lexer, out *HTTPIngressRuleValue) {
...
func easyjson658ab631EncodeGithubComKubewardenK8sObjectsApiNetworkingV1beta1(out *jwriter.Writer, in HTTPIngressRuleValue) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v HTTPIngressRuleValue) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson658ab631EncodeGithubComKubewardenK8sObjectsApiNetworkingV1beta1(&w, v)
...
func (v *HTTPIngressRuleValue) UnmarshalJSON(data []byte) error {
	...
	easyjson658ab631DecodeGithubComKubewardenK8sObjectsApiNetworkingV1beta1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *HTTPIngressRuleValue) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson658ab631DecodeGithubComKubewardenK8sObjectsApiNetworkingV1beta1(l, v)
}
