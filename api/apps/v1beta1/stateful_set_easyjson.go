...
func easyjsonB4d3c875DecodeGithubComKubewardenK8sObjectsApiAppsV1beta1(in *jlexer.Lexer, out *StatefulSet) {
	...
	for !in.IsDelim('}') {
		...
		case "spec":
			if in.IsNull() {
				...
				easyjsonB4d3c875DecodeGithubComKubewardenK8sObjectsApiAppsV1beta11(in, out.Spec)
			}
		case "status":
			if in.IsNull() {
				in.Skip()
				...
				easyjsonB4d3c875DecodeGithubComKubewardenK8sObjectsApiAppsV1beta12(in, out.Status)
			}
		default:
			in.SkipRecursive()
		}
...
func easyjsonB4d3c875EncodeGithubComKubewardenK8sObjectsApiAppsV1beta1(out *jwriter.Writer, in StatefulSet) {
	out.RawByte('{')
	first := true
	_ = first
	if in.APIVersion != "" {
	...
	if in.Spec != nil {
		...
		easyjsonB4d3c875EncodeGithubComKubewardenK8sObjectsApiAppsV1beta11(out, *in.Spec)
	}
	if in.Status != nil {
		...
		easyjsonB4d3c875EncodeGithubComKubewardenK8sObjectsApiAppsV1beta12(out, *in.Status)
	}
	out.RawByte('}')
}
...
func (v StatefulSet) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonB4d3c875EncodeGithubComKubewardenK8sObjectsApiAppsV1beta1(&w, v)
...
func (v *StatefulSet) UnmarshalJSON(data []byte) error {
	...
	easyjsonB4d3c875DecodeGithubComKubewardenK8sObjectsApiAppsV1beta1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *StatefulSet) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonB4d3c875DecodeGithubComKubewardenK8sObjectsApiAppsV1beta1(l, v)
}
func easyjsonB4d3c875DecodeGithubComKubewardenK8sObjectsApiAppsV1beta12(in *jlexer.Lexer, out *StatefulSetStatus) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjsonB4d3c875DecodeGithubComKubewardenK8sObjectsApiAppsV1beta13(in, v1)
					}
...
func easyjsonB4d3c875EncodeGithubComKubewardenK8sObjectsApiAppsV1beta12(out *jwriter.Writer, in StatefulSetStatus) {
	out.RawByte('{')
	first := true
	_ = first
		...
		if in.Conditions == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v2, v3 := range in.Conditions {
				...
				if v3 == nil {
					...
					easyjsonB4d3c875EncodeGithubComKubewardenK8sObjectsApiAppsV1beta13(out, *v3)
				}
			}
			out.RawByte(']')
		}
...
func easyjsonB4d3c875DecodeGithubComKubewardenK8sObjectsApiAppsV1beta13(in *jlexer.Lexer, out *StatefulSetCondition) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonB4d3c875EncodeGithubComKubewardenK8sObjectsApiAppsV1beta13(out *jwriter.Writer, in StatefulSetCondition) {
	out.RawByte('{')
	first := true
	_ = first
	if true {
...
func easyjsonB4d3c875DecodeGithubComKubewardenK8sObjectsApiAppsV1beta11(in *jlexer.Lexer, out *StatefulSetSpec) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "updateStrategy":
			if in.IsNull() {
				...
				easyjsonB4d3c875DecodeGithubComKubewardenK8sObjectsApiAppsV1beta14(in, out.UpdateStrategy)
			}
		case "volumeClaimTemplates":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v4 _v1.PersistentVolumeClaim
...
func easyjsonB4d3c875EncodeGithubComKubewardenK8sObjectsApiAppsV1beta11(out *jwriter.Writer, in StatefulSetSpec) {
	out.RawByte('{')
	first := true
	_ = first
	...
	if in.UpdateStrategy != nil {
		...
		out.RawString(prefix)
		easyjsonB4d3c875EncodeGithubComKubewardenK8sObjectsApiAppsV1beta14(out, *in.UpdateStrategy)
	}
	{
...
func easyjsonB4d3c875DecodeGithubComKubewardenK8sObjectsApiAppsV1beta14(in *jlexer.Lexer, out *StatefulSetUpdateStrategy) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonB4d3c875EncodeGithubComKubewardenK8sObjectsApiAppsV1beta14(out *jwriter.Writer, in StatefulSetUpdateStrategy) {
	out.RawByte('{')
	first := true
	_ = first
