...
func easyjson9460807fDecodeGithubComKubewardenK8sObjectsApiAppsV1beta1(in *jlexer.Lexer, out *DeploymentSpec) {
	...
	for !in.IsDelim('}') {
		...
		case "rollbackTo":
			if in.IsNull() {
				...
				easyjson9460807fDecodeGithubComKubewardenK8sObjectsApiAppsV1beta11(in, out.RollbackTo)
			}
		case "selector":
			if in.IsNull() {
				in.Skip()
		...
		case "strategy":
			if in.IsNull() {
				...
				easyjson9460807fDecodeGithubComKubewardenK8sObjectsApiAppsV1beta12(in, out.Strategy)
			}
		case "template":
			if in.IsNull() {
				in.Skip()
...
func easyjson9460807fEncodeGithubComKubewardenK8sObjectsApiAppsV1beta1(out *jwriter.Writer, in DeploymentSpec) {
	out.RawByte('{')
	first := true
	_ = first
	...
	if in.RollbackTo != nil {
		...
		easyjson9460807fEncodeGithubComKubewardenK8sObjectsApiAppsV1beta11(out, *in.RollbackTo)
	}
	if in.Selector != nil {
	...
	if in.Strategy != nil {
		...
		easyjson9460807fEncodeGithubComKubewardenK8sObjectsApiAppsV1beta12(out, *in.Strategy)
	}
	{
...
func (v DeploymentSpec) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson9460807fEncodeGithubComKubewardenK8sObjectsApiAppsV1beta1(&w, v)
...
func (v *DeploymentSpec) UnmarshalJSON(data []byte) error {
	...
	easyjson9460807fDecodeGithubComKubewardenK8sObjectsApiAppsV1beta1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *DeploymentSpec) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson9460807fDecodeGithubComKubewardenK8sObjectsApiAppsV1beta1(l, v)
}
func easyjson9460807fDecodeGithubComKubewardenK8sObjectsApiAppsV1beta12(in *jlexer.Lexer, out *DeploymentStrategy) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "rollingUpdate":
			if in.IsNull() {
				...
				easyjson9460807fDecodeGithubComKubewardenK8sObjectsApiAppsV1beta13(in, out.RollingUpdate)
			}
		case "type":
...
func easyjson9460807fEncodeGithubComKubewardenK8sObjectsApiAppsV1beta12(out *jwriter.Writer, in DeploymentStrategy) {
	out.RawByte('{')
	first := true
	_ = first
	if in.RollingUpdate != nil {
		...
		first = false
		out.RawString(prefix[1:])
		easyjson9460807fEncodeGithubComKubewardenK8sObjectsApiAppsV1beta13(out, *in.RollingUpdate)
	}
	if in.Type != "" {
...
func easyjson9460807fDecodeGithubComKubewardenK8sObjectsApiAppsV1beta13(in *jlexer.Lexer, out *RollingUpdateDeployment) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson9460807fEncodeGithubComKubewardenK8sObjectsApiAppsV1beta13(out *jwriter.Writer, in RollingUpdateDeployment) {
	out.RawByte('{')
	first := true
	_ = first
	if in.MaxSurge != nil {
...
func easyjson9460807fDecodeGithubComKubewardenK8sObjectsApiAppsV1beta11(in *jlexer.Lexer, out *RollbackConfig) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson9460807fEncodeGithubComKubewardenK8sObjectsApiAppsV1beta11(out *jwriter.Writer, in RollbackConfig) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Revision != 0 {
