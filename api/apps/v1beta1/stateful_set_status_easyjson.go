...
func easyjson30c5d56cDecodeGithubComKubewardenK8sObjectsApiAppsV1beta1(in *jlexer.Lexer, out *StatefulSetStatus) {
...
func easyjson30c5d56cEncodeGithubComKubewardenK8sObjectsApiAppsV1beta1(out *jwriter.Writer, in StatefulSetStatus) {
	out.RawByte('{')
	first := true
	_ = first
...
func (v StatefulSetStatus) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson30c5d56cEncodeGithubComKubewardenK8sObjectsApiAppsV1beta1(&w, v)
...
func (v *StatefulSetStatus) UnmarshalJSON(data []byte) error {
	...
	easyjson30c5d56cDecodeGithubComKubewardenK8sObjectsApiAppsV1beta1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *StatefulSetStatus) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson30c5d56cDecodeGithubComKubewardenK8sObjectsApiAppsV1beta1(l, v)
}
