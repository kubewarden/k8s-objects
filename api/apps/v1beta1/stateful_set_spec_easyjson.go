...
func easyjsonC8b5e123DecodeGithubComKubewardenK8sObjectsApiAppsV1beta1(in *jlexer.Lexer, out *StatefulSetSpec) {
	...
	for !in.IsDelim('}') {
		...
		case "updateStrategy":
			if in.IsNull() {
				...
				easyjsonC8b5e123DecodeGithubComKubewardenK8sObjectsApiAppsV1beta11(in, out.UpdateStrategy)
			}
...
func easyjsonC8b5e123EncodeGithubComKubewardenK8sObjectsApiAppsV1beta1(out *jwriter.Writer, in StatefulSetSpec) {
	out.RawByte('{')
	first := true
	_ = first
...
func (v StatefulSetSpec) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonC8b5e123EncodeGithubComKubewardenK8sObjectsApiAppsV1beta1(&w, v)
...
func (v *StatefulSetSpec) UnmarshalJSON(data []byte) error {
	...
	easyjsonC8b5e123DecodeGithubComKubewardenK8sObjectsApiAppsV1beta1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *StatefulSetSpec) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonC8b5e123DecodeGithubComKubewardenK8sObjectsApiAppsV1beta1(l, v)
}
func easyjsonC8b5e123DecodeGithubComKubewardenK8sObjectsApiAppsV1beta11(in *jlexer.Lexer, out *StatefulSetUpdateStrategy) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonC8b5e123EncodeGithubComKubewardenK8sObjectsApiAppsV1beta11(out *jwriter.Writer, in StatefulSetUpdateStrategy) {
	out.RawByte('{')
	first := true
	_ = first
