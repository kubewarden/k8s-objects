...
func easyjsonC7c6e959DecodeGithubComKubewardenK8sObjectsApiAppsV1beta1(in *jlexer.Lexer, out *Deployment) {
	...
	for !in.IsDelim('}') {
		...
		case "spec":
			if in.IsNull() {
				...
				easyjsonC7c6e959DecodeGithubComKubewardenK8sObjectsApiAppsV1beta11(in, out.Spec)
			}
		case "status":
			if in.IsNull() {
				in.Skip()
				...
				easyjsonC7c6e959DecodeGithubComKubewardenK8sObjectsApiAppsV1beta12(in, out.Status)
			}
		default:
			in.SkipRecursive()
		}
...
func easyjsonC7c6e959EncodeGithubComKubewardenK8sObjectsApiAppsV1beta1(out *jwriter.Writer, in Deployment) {
	out.RawByte('{')
	first := true
	_ = first
	if in.APIVersion != "" {
	...
	if in.Spec != nil {
		...
		easyjsonC7c6e959EncodeGithubComKubewardenK8sObjectsApiAppsV1beta11(out, *in.Spec)
	}
	if in.Status != nil {
		...
		easyjsonC7c6e959EncodeGithubComKubewardenK8sObjectsApiAppsV1beta12(out, *in.Status)
	}
	out.RawByte('}')
}
...
func (v Deployment) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonC7c6e959EncodeGithubComKubewardenK8sObjectsApiAppsV1beta1(&w, v)
...
func (v *Deployment) UnmarshalJSON(data []byte) error {
	...
	easyjsonC7c6e959DecodeGithubComKubewardenK8sObjectsApiAppsV1beta1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Deployment) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonC7c6e959DecodeGithubComKubewardenK8sObjectsApiAppsV1beta1(l, v)
}
func easyjsonC7c6e959DecodeGithubComKubewardenK8sObjectsApiAppsV1beta12(in *jlexer.Lexer, out *DeploymentStatus) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjsonC7c6e959DecodeGithubComKubewardenK8sObjectsApiAppsV1beta13(in, v1)
					}
...
func easyjsonC7c6e959EncodeGithubComKubewardenK8sObjectsApiAppsV1beta12(out *jwriter.Writer, in DeploymentStatus) {
	out.RawByte('{')
	first := true
	_ = first
		...
		}
		{
			...
			for v2, v3 := range in.Conditions {
				...
				if v3 == nil {
					...
					easyjsonC7c6e959EncodeGithubComKubewardenK8sObjectsApiAppsV1beta13(out, *v3)
				}
			}
			out.RawByte(']')
		}
...
func easyjsonC7c6e959DecodeGithubComKubewardenK8sObjectsApiAppsV1beta13(in *jlexer.Lexer, out *DeploymentCondition) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonC7c6e959EncodeGithubComKubewardenK8sObjectsApiAppsV1beta13(out *jwriter.Writer, in DeploymentCondition) {
	out.RawByte('{')
	first := true
	_ = first
...
func easyjsonC7c6e959DecodeGithubComKubewardenK8sObjectsApiAppsV1beta11(in *jlexer.Lexer, out *DeploymentSpec) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "rollbackTo":
			if in.IsNull() {
				...
				easyjsonC7c6e959DecodeGithubComKubewardenK8sObjectsApiAppsV1beta14(in, out.RollbackTo)
			}
		case "selector":
			if in.IsNull() {
				in.Skip()
		...
		case "strategy":
			if in.IsNull() {
				...
				easyjsonC7c6e959DecodeGithubComKubewardenK8sObjectsApiAppsV1beta15(in, out.Strategy)
			}
		case "template":
			if in.IsNull() {
				in.Skip()
...
func easyjsonC7c6e959EncodeGithubComKubewardenK8sObjectsApiAppsV1beta11(out *jwriter.Writer, in DeploymentSpec) {
	out.RawByte('{')
	first := true
	_ = first
	...
	if in.RollbackTo != nil {
		...
		easyjsonC7c6e959EncodeGithubComKubewardenK8sObjectsApiAppsV1beta14(out, *in.RollbackTo)
	}
	if in.Selector != nil {
	...
	if in.Strategy != nil {
		...
		easyjsonC7c6e959EncodeGithubComKubewardenK8sObjectsApiAppsV1beta15(out, *in.Strategy)
	}
	{
...
func easyjsonC7c6e959DecodeGithubComKubewardenK8sObjectsApiAppsV1beta15(in *jlexer.Lexer, out *DeploymentStrategy) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "rollingUpdate":
			if in.IsNull() {
				...
				easyjsonC7c6e959DecodeGithubComKubewardenK8sObjectsApiAppsV1beta16(in, out.RollingUpdate)
			}
		case "type":
			out.Type = string(in.String())
		default:
...
func easyjsonC7c6e959EncodeGithubComKubewardenK8sObjectsApiAppsV1beta15(out *jwriter.Writer, in DeploymentStrategy) {
	out.RawByte('{')
	first := true
	_ = first
	if in.RollingUpdate != nil {
		...
		first = false
		out.RawString(prefix[1:])
		easyjsonC7c6e959EncodeGithubComKubewardenK8sObjectsApiAppsV1beta16(out, *in.RollingUpdate)
	}
	if in.Type != "" {
		const prefix string = ",\"type\":"
		if first {
...
func easyjsonC7c6e959DecodeGithubComKubewardenK8sObjectsApiAppsV1beta16(in *jlexer.Lexer, out *RollingUpdateDeployment) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonC7c6e959EncodeGithubComKubewardenK8sObjectsApiAppsV1beta16(out *jwriter.Writer, in RollingUpdateDeployment) {
	out.RawByte('{')
	first := true
	_ = first
	if in.MaxSurge != nil {
...
func easyjsonC7c6e959DecodeGithubComKubewardenK8sObjectsApiAppsV1beta14(in *jlexer.Lexer, out *RollbackConfig) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonC7c6e959EncodeGithubComKubewardenK8sObjectsApiAppsV1beta14(out *jwriter.Writer, in RollbackConfig) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Revision != 0 {
