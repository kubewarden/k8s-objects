...
func easyjson21f59f41DecodeGithubComKubewardenK8sObjectsApiAppsV1beta2(in *jlexer.Lexer, out *DaemonSet) {
	...
	for !in.IsDelim('}') {
		...
		case "spec":
			if in.IsNull() {
				...
				easyjson21f59f41DecodeGithubComKubewardenK8sObjectsApiAppsV1beta21(in, out.Spec)
			}
		case "status":
			if in.IsNull() {
				in.Skip()
				...
				easyjson21f59f41DecodeGithubComKubewardenK8sObjectsApiAppsV1beta22(in, out.Status)
			}
		default:
			in.SkipRecursive()
		}
...
func easyjson21f59f41EncodeGithubComKubewardenK8sObjectsApiAppsV1beta2(out *jwriter.Writer, in DaemonSet) {
	out.RawByte('{')
	first := true
	_ = first
	if in.APIVersion != "" {
	...
	if in.Spec != nil {
		...
		easyjson21f59f41EncodeGithubComKubewardenK8sObjectsApiAppsV1beta21(out, *in.Spec)
	}
	if in.Status != nil {
		...
		easyjson21f59f41EncodeGithubComKubewardenK8sObjectsApiAppsV1beta22(out, *in.Status)
	}
	out.RawByte('}')
}
...
func (v DaemonSet) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson21f59f41EncodeGithubComKubewardenK8sObjectsApiAppsV1beta2(&w, v)
...
func (v *DaemonSet) UnmarshalJSON(data []byte) error {
	...
	easyjson21f59f41DecodeGithubComKubewardenK8sObjectsApiAppsV1beta2(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *DaemonSet) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson21f59f41DecodeGithubComKubewardenK8sObjectsApiAppsV1beta2(l, v)
}
func easyjson21f59f41DecodeGithubComKubewardenK8sObjectsApiAppsV1beta22(in *jlexer.Lexer, out *DaemonSetStatus) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjson21f59f41DecodeGithubComKubewardenK8sObjectsApiAppsV1beta23(in, v1)
					}
...
func easyjson21f59f41EncodeGithubComKubewardenK8sObjectsApiAppsV1beta22(out *jwriter.Writer, in DaemonSetStatus) {
	out.RawByte('{')
	first := true
	_ = first
		...
		if in.Conditions == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v2, v3 := range in.Conditions {
				...
				if v3 == nil {
					...
					easyjson21f59f41EncodeGithubComKubewardenK8sObjectsApiAppsV1beta23(out, *v3)
				}
			}
			out.RawByte(']')
		}
...
func easyjson21f59f41DecodeGithubComKubewardenK8sObjectsApiAppsV1beta23(in *jlexer.Lexer, out *DaemonSetCondition) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson21f59f41EncodeGithubComKubewardenK8sObjectsApiAppsV1beta23(out *jwriter.Writer, in DaemonSetCondition) {
	out.RawByte('{')
	first := true
	_ = first
	if true {
...
func easyjson21f59f41DecodeGithubComKubewardenK8sObjectsApiAppsV1beta21(in *jlexer.Lexer, out *DaemonSetSpec) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "updateStrategy":
			if in.IsNull() {
				...
				easyjson21f59f41DecodeGithubComKubewardenK8sObjectsApiAppsV1beta24(in, out.UpdateStrategy)
			}
		default:
			in.SkipRecursive()
		}
...
func easyjson21f59f41EncodeGithubComKubewardenK8sObjectsApiAppsV1beta21(out *jwriter.Writer, in DaemonSetSpec) {
	out.RawByte('{')
	first := true
	_ = first
	...
	if in.UpdateStrategy != nil {
		...
		out.RawString(prefix)
		easyjson21f59f41EncodeGithubComKubewardenK8sObjectsApiAppsV1beta24(out, *in.UpdateStrategy)
	}
	out.RawByte('}')
}
func easyjson21f59f41DecodeGithubComKubewardenK8sObjectsApiAppsV1beta24(in *jlexer.Lexer, out *DaemonSetUpdateStrategy) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "rollingUpdate":
			if in.IsNull() {
				...
				easyjson21f59f41DecodeGithubComKubewardenK8sObjectsApiAppsV1beta25(in, out.RollingUpdate)
			}
		case "type":
			out.Type = string(in.String())
		default:
...
func easyjson21f59f41EncodeGithubComKubewardenK8sObjectsApiAppsV1beta24(out *jwriter.Writer, in DaemonSetUpdateStrategy) {
	out.RawByte('{')
	first := true
	_ = first
	if in.RollingUpdate != nil {
		...
		first = false
		out.RawString(prefix[1:])
		easyjson21f59f41EncodeGithubComKubewardenK8sObjectsApiAppsV1beta25(out, *in.RollingUpdate)
	}
	if in.Type != "" {
		const prefix string = ",\"type\":"
		if first {
...
func easyjson21f59f41DecodeGithubComKubewardenK8sObjectsApiAppsV1beta25(in *jlexer.Lexer, out *RollingUpdateDaemonSet) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson21f59f41EncodeGithubComKubewardenK8sObjectsApiAppsV1beta25(out *jwriter.Writer, in RollingUpdateDaemonSet) {
	out.RawByte('{')
	first := true
	_ = first
