...
func easyjsonE559dd25DecodeGithubComKubewardenK8sObjectsApiAppsV1beta2(in *jlexer.Lexer, out *ReplicaSetSpec) {
...
func easyjsonE559dd25EncodeGithubComKubewardenK8sObjectsApiAppsV1beta2(out *jwriter.Writer, in ReplicaSetSpec) {
	out.RawByte('{')
	first := true
	_ = first
...
func (v ReplicaSetSpec) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonE559dd25EncodeGithubComKubewardenK8sObjectsApiAppsV1beta2(&w, v)
...
func (v *ReplicaSetSpec) UnmarshalJSON(data []byte) error {
	...
	easyjsonE559dd25DecodeGithubComKubewardenK8sObjectsApiAppsV1beta2(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *ReplicaSetSpec) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonE559dd25DecodeGithubComKubewardenK8sObjectsApiAppsV1beta2(l, v)
}
