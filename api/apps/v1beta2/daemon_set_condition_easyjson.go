...
func easyjson65a00d7DecodeGithubComKubewardenK8sObjectsApiAppsV1beta2(in *jlexer.Lexer, out *DaemonSetCondition) {
...
func easyjson65a00d7EncodeGithubComKubewardenK8sObjectsApiAppsV1beta2(out *jwriter.Writer, in DaemonSetCondition) {
	out.RawByte('{')
	first := true
	_ = first
...
func (v DaemonSetCondition) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson65a00d7EncodeGithubComKubewardenK8sObjectsApiAppsV1beta2(&w, v)
...
func (v *DaemonSetCondition) UnmarshalJSON(data []byte) error {
	...
	easyjson65a00d7DecodeGithubComKubewardenK8sObjectsApiAppsV1beta2(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *DaemonSetCondition) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson65a00d7DecodeGithubComKubewardenK8sObjectsApiAppsV1beta2(l, v)
}
