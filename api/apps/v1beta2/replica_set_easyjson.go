...
func easyjson1601854fDecodeGithubComKubewardenK8sObjectsApiAppsV1beta2(in *jlexer.Lexer, out *ReplicaSet) {
	...
	for !in.IsDelim('}') {
		...
		case "spec":
			if in.IsNull() {
				...
				easyjson1601854fDecodeGithubComKubewardenK8sObjectsApiAppsV1beta21(in, out.Spec)
			}
		case "status":
			if in.IsNull() {
				in.Skip()
				...
				easyjson1601854fDecodeGithubComKubewardenK8sObjectsApiAppsV1beta22(in, out.Status)
			}
		default:
			in.SkipRecursive()
		}
...
func easyjson1601854fEncodeGithubComKubewardenK8sObjectsApiAppsV1beta2(out *jwriter.Writer, in ReplicaSet) {
	out.RawByte('{')
	first := true
	_ = first
	if in.APIVersion != "" {
	...
	if in.Spec != nil {
		...
		easyjson1601854fEncodeGithubComKubewardenK8sObjectsApiAppsV1beta21(out, *in.Spec)
	}
	if in.Status != nil {
		...
		easyjson1601854fEncodeGithubComKubewardenK8sObjectsApiAppsV1beta22(out, *in.Status)
	}
	out.RawByte('}')
}
...
func (v ReplicaSet) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson1601854fEncodeGithubComKubewardenK8sObjectsApiAppsV1beta2(&w, v)
...
func (v *ReplicaSet) UnmarshalJSON(data []byte) error {
	...
	easyjson1601854fDecodeGithubComKubewardenK8sObjectsApiAppsV1beta2(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *ReplicaSet) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson1601854fDecodeGithubComKubewardenK8sObjectsApiAppsV1beta2(l, v)
}
func easyjson1601854fDecodeGithubComKubewardenK8sObjectsApiAppsV1beta22(in *jlexer.Lexer, out *ReplicaSetStatus) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjson1601854fDecodeGithubComKubewardenK8sObjectsApiAppsV1beta23(in, v1)
					}
...
func easyjson1601854fEncodeGithubComKubewardenK8sObjectsApiAppsV1beta22(out *jwriter.Writer, in ReplicaSetStatus) {
	out.RawByte('{')
	first := true
	_ = first
		...
		}
		{
			...
			for v2, v3 := range in.Conditions {
				...
				if v3 == nil {
					...
					easyjson1601854fEncodeGithubComKubewardenK8sObjectsApiAppsV1beta23(out, *v3)
				}
			}
			out.RawByte(']')
		}
...
func easyjson1601854fDecodeGithubComKubewardenK8sObjectsApiAppsV1beta23(in *jlexer.Lexer, out *ReplicaSetCondition) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson1601854fEncodeGithubComKubewardenK8sObjectsApiAppsV1beta23(out *jwriter.Writer, in ReplicaSetCondition) {
	out.RawByte('{')
	first := true
	_ = first
...
func easyjson1601854fDecodeGithubComKubewardenK8sObjectsApiAppsV1beta21(in *jlexer.Lexer, out *ReplicaSetSpec) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson1601854fEncodeGithubComKubewardenK8sObjectsApiAppsV1beta21(out *jwriter.Writer, in ReplicaSetSpec) {
	out.RawByte('{')
	first := true
	_ = first
