...
func easyjsonE6692ddbDecodeGithubComKubewardenK8sObjectsApiAppsV1beta2(in *jlexer.Lexer, out *RollingUpdateDeployment) {
...
func easyjsonE6692ddbEncodeGithubComKubewardenK8sObjectsApiAppsV1beta2(out *jwriter.Writer, in RollingUpdateDeployment) {
	out.RawByte('{')
	first := true
	_ = first
	if in.MaxSurge != "" {
...
func (v RollingUpdateDeployment) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonE6692ddbEncodeGithubComKubewardenK8sObjectsApiAppsV1beta2(&w, v)
...
func (v *RollingUpdateDeployment) UnmarshalJSON(data []byte) error {
	...
	easyjsonE6692ddbDecodeGithubComKubewardenK8sObjectsApiAppsV1beta2(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *RollingUpdateDeployment) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonE6692ddbDecodeGithubComKubewardenK8sObjectsApiAppsV1beta2(l, v)
}
