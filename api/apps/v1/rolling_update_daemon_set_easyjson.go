...
func easyjsonEdf3b953DecodeGithubComKubewardenK8sObjectsApiAppsV1(in *jlexer.Lexer, out *RollingUpdateDaemonSet) {
...
func easyjsonEdf3b953EncodeGithubComKubewardenK8sObjectsApiAppsV1(out *jwriter.Writer, in RollingUpdateDaemonSet) {
	out.RawByte('{')
	first := true
	_ = first
...
func (v RollingUpdateDaemonSet) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonEdf3b953EncodeGithubComKubewardenK8sObjectsApiAppsV1(&w, v)
...
func (v *RollingUpdateDaemonSet) UnmarshalJSON(data []byte) error {
	...
	easyjsonEdf3b953DecodeGithubComKubewardenK8sObjectsApiAppsV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *RollingUpdateDaemonSet) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonEdf3b953DecodeGithubComKubewardenK8sObjectsApiAppsV1(l, v)
}
