...
func easyjson15425908DecodeGithubComKubewardenK8sObjectsApiEventsV1(in *jlexer.Lexer, out *EventSeries) {
...
func easyjson15425908EncodeGithubComKubewardenK8sObjectsApiEventsV1(out *jwriter.Writer, in EventSeries) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v EventSeries) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson15425908EncodeGithubComKubewardenK8sObjectsApiEventsV1(&w, v)
...
func (v *EventSeries) UnmarshalJSON(data []byte) error {
	...
	easyjson15425908DecodeGithubComKubewardenK8sObjectsApiEventsV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *EventSeries) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson15425908DecodeGithubComKubewardenK8sObjectsApiEventsV1(l, v)
}
