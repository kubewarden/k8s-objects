...
func easyjson3f91c269DecodeGithubComKubewardenK8sObjectsApiAdmissionregistrationV1beta1(in *jlexer.Lexer, out *Webhook) {
	...
	for !in.IsDelim('}') {
		...
		case "clientConfig":
			if in.IsNull() {
				...
				easyjson3f91c269DecodeGithubComKubewardenK8sObjectsApiAdmissionregistrationV1beta11(in, out.ClientConfig)
			}
		case "failurePolicy":
...
func easyjson3f91c269EncodeGithubComKubewardenK8sObjectsApiAdmissionregistrationV1beta1(out *jwriter.Writer, in Webhook) {
	out.RawByte('{')
	first := true
	_ = first
	...
	}
	{
		...
		if in.ClientConfig == nil {
			...
			easyjson3f91c269EncodeGithubComKubewardenK8sObjectsApiAdmissionregistrationV1beta11(out, *in.ClientConfig)
		}
	}
	if in.FailurePolicy != "" {
...
func (v Webhook) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson3f91c269EncodeGithubComKubewardenK8sObjectsApiAdmissionregistrationV1beta1(&w, v)
...
func (v *Webhook) UnmarshalJSON(data []byte) error {
	...
	easyjson3f91c269DecodeGithubComKubewardenK8sObjectsApiAdmissionregistrationV1beta1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Webhook) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson3f91c269DecodeGithubComKubewardenK8sObjectsApiAdmissionregistrationV1beta1(l, v)
}
func easyjson3f91c269DecodeGithubComKubewardenK8sObjectsApiAdmissionregistrationV1beta11(in *jlexer.Lexer, out *WebhookClientConfig) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson3f91c269EncodeGithubComKubewardenK8sObjectsApiAdmissionregistrationV1beta11(out *jwriter.Writer, in WebhookClientConfig) {
	out.RawByte('{')
	first := true
	_ = first
