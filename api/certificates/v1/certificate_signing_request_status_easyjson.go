...
func easyjson6572c698DecodeGithubComKubewardenK8sObjectsApiCertificatesV1(in *jlexer.Lexer, out *CertificateSigningRequestStatus) {
...
func easyjson6572c698EncodeGithubComKubewardenK8sObjectsApiCertificatesV1(out *jwriter.Writer, in CertificateSigningRequestStatus) {
	out.RawByte('{')
	first := true
	_ = first
...
func (v CertificateSigningRequestStatus) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson6572c698EncodeGithubComKubewardenK8sObjectsApiCertificatesV1(&w, v)
...
func (v *CertificateSigningRequestStatus) UnmarshalJSON(data []byte) error {
	...
	easyjson6572c698DecodeGithubComKubewardenK8sObjectsApiCertificatesV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *CertificateSigningRequestStatus) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson6572c698DecodeGithubComKubewardenK8sObjectsApiCertificatesV1(l, v)
}
