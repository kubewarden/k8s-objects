...
func easyjson7bd069bfDecodeGithubComKubewardenK8sObjectsApiCertificatesV1beta1(in *jlexer.Lexer, out *CertificateSigningRequestSpec) {
...
func easyjson7bd069bfEncodeGithubComKubewardenK8sObjectsApiCertificatesV1beta1(out *jwriter.Writer, in CertificateSigningRequestSpec) {
	out.RawByte('{')
	first := true
	_ = first
	if len(in.Extra) != 0 {
...
func (v CertificateSigningRequestSpec) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson7bd069bfEncodeGithubComKubewardenK8sObjectsApiCertificatesV1beta1(&w, v)
...
func (v *CertificateSigningRequestSpec) UnmarshalJSON(data []byte) error {
	...
	easyjson7bd069bfDecodeGithubComKubewardenK8sObjectsApiCertificatesV1beta1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *CertificateSigningRequestSpec) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson7bd069bfDecodeGithubComKubewardenK8sObjectsApiCertificatesV1beta1(l, v)
}
