...
func easyjsonD9c99f82DecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1beta3(in *jlexer.Lexer, out *NonResourcePolicyRule) {
...
func easyjsonD9c99f82EncodeGithubComKubewardenK8sObjectsApiFlowcontrolV1beta3(out *jwriter.Writer, in NonResourcePolicyRule) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v NonResourcePolicyRule) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonD9c99f82EncodeGithubComKubewardenK8sObjectsApiFlowcontrolV1beta3(&w, v)
...
func (v *NonResourcePolicyRule) UnmarshalJSON(data []byte) error {
	...
	easyjsonD9c99f82DecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1beta3(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *NonResourcePolicyRule) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonD9c99f82DecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1beta3(l, v)
}
