...
func easyjson3312364bDecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1beta2(in *jlexer.Lexer, out *FlowSchemaStatus) {
...
func easyjson3312364bEncodeGithubComKubewardenK8sObjectsApiFlowcontrolV1beta2(out *jwriter.Writer, in FlowSchemaStatus) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v FlowSchemaStatus) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson3312364bEncodeGithubComKubewardenK8sObjectsApiFlowcontrolV1beta2(&w, v)
...
func (v *FlowSchemaStatus) UnmarshalJSON(data []byte) error {
	...
	easyjson3312364bDecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1beta2(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *FlowSchemaStatus) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson3312364bDecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1beta2(l, v)
}
