...
func easyjsonCc6d646DecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1beta2(in *jlexer.Lexer, out *ResourcePolicyRule) {
...
func easyjsonCc6d646EncodeGithubComKubewardenK8sObjectsApiFlowcontrolV1beta2(out *jwriter.Writer, in ResourcePolicyRule) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v ResourcePolicyRule) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonCc6d646EncodeGithubComKubewardenK8sObjectsApiFlowcontrolV1beta2(&w, v)
...
func (v *ResourcePolicyRule) UnmarshalJSON(data []byte) error {
	...
	easyjsonCc6d646DecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1beta2(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *ResourcePolicyRule) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonCc6d646DecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1beta2(l, v)
}
