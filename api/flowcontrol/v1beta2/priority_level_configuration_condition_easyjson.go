...
func easyjson62aabc1aDecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1beta2(in *jlexer.Lexer, out *PriorityLevelConfigurationCondition) {
...
func easyjson62aabc1aEncodeGithubComKubewardenK8sObjectsApiFlowcontrolV1beta2(out *jwriter.Writer, in PriorityLevelConfigurationCondition) {
	out.RawByte('{')
	first := true
	_ = first
...
func (v PriorityLevelConfigurationCondition) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson62aabc1aEncodeGithubComKubewardenK8sObjectsApiFlowcontrolV1beta2(&w, v)
...
func (v *PriorityLevelConfigurationCondition) UnmarshalJSON(data []byte) error {
	...
	easyjson62aabc1aDecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1beta2(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PriorityLevelConfigurationCondition) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson62aabc1aDecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1beta2(l, v)
}
