...
func easyjson211b8a67DecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1beta1(in *jlexer.Lexer, out *PriorityLevelConfigurationStatus) {
...
func easyjson211b8a67EncodeGithubComKubewardenK8sObjectsApiFlowcontrolV1beta1(out *jwriter.Writer, in PriorityLevelConfigurationStatus) {
	out.RawByte('{')
	first := true
	_ = first
...
func (v PriorityLevelConfigurationStatus) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson211b8a67EncodeGithubComKubewardenK8sObjectsApiFlowcontrolV1beta1(&w, v)
...
func (v *PriorityLevelConfigurationStatus) UnmarshalJSON(data []byte) error {
	...
	easyjson211b8a67DecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1beta1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PriorityLevelConfigurationStatus) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson211b8a67DecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1beta1(l, v)
}
