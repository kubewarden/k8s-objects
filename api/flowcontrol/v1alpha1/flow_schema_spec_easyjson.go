...
func easyjson8714318cDecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha1(in *jlexer.Lexer, out *FlowSchemaSpec) {
	...
	for !in.IsDelim('}') {
		...
		case "priorityLevelConfiguration":
			if in.IsNull() {
				...
				easyjson8714318cDecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha11(in, out.PriorityLevelConfiguration)
			}
		case "rules":
			if in.IsNull() {
				in.Skip()
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjson8714318cDecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha12(in, v1)
					}
...
func easyjson8714318cEncodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha1(out *jwriter.Writer, in FlowSchemaSpec) {
	out.RawByte('{')
	first := true
	_ = first
	...
	}
	{
		...
		if in.PriorityLevelConfiguration == nil {
			...
			easyjson8714318cEncodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha11(out, *in.PriorityLevelConfiguration)
		}
	}
	{
		...
		if in.Rules == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v2, v3 := range in.Rules {
				...
				if v3 == nil {
					...
					easyjson8714318cEncodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha12(out, *v3)
				}
			}
			out.RawByte(']')
		}
...
func (v FlowSchemaSpec) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson8714318cEncodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha1(&w, v)
...
func (v *FlowSchemaSpec) UnmarshalJSON(data []byte) error {
	...
	easyjson8714318cDecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *FlowSchemaSpec) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson8714318cDecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha1(l, v)
}
func easyjson8714318cDecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha12(in *jlexer.Lexer, out *PolicyRulesWithSubjects) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjson8714318cDecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha13(in, v4)
					}
			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjson8714318cDecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha14(in, v5)
					}
			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjson8714318cDecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha15(in, v6)
					}
...
func easyjson8714318cEncodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha12(out *jwriter.Writer, in PolicyRulesWithSubjects) {
	out.RawByte('{')
	first := true
	_ = first
	{
		...
		if in.NonResourceRules == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v7, v8 := range in.NonResourceRules {
				...
				if v8 == nil {
					...
					easyjson8714318cEncodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha13(out, *v8)
				}
			}
			out.RawByte(']')
		}
		...
		if in.ResourceRules == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v9, v10 := range in.ResourceRules {
				...
				if v10 == nil {
					...
					easyjson8714318cEncodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha14(out, *v10)
				}
			}
			out.RawByte(']')
		}
		...
		if in.Subjects == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v11, v12 := range in.Subjects {
				...
				if v12 == nil {
					...
					easyjson8714318cEncodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha15(out, *v12)
				}
			}
			out.RawByte(']')
		}
...
func easyjson8714318cDecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha15(in *jlexer.Lexer, out *Subject) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "group":
			if in.IsNull() {
				...
				easyjson8714318cDecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha16(in, out.Group)
			}
		case "kind":
			if in.IsNull() {
				in.Skip()
		...
		case "serviceAccount":
			if in.IsNull() {
				...
				easyjson8714318cDecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha17(in, out.ServiceAccount)
			}
		case "user":
			if in.IsNull() {
				in.Skip()
				...
				easyjson8714318cDecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha18(in, out.User)
			}
		default:
			in.SkipRecursive()
		}
...
func easyjson8714318cEncodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha15(out *jwriter.Writer, in Subject) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Group != nil {
		...
		first = false
		out.RawString(prefix[1:])
		easyjson8714318cEncodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha16(out, *in.Group)
	}
	{
	...
	if in.ServiceAccount != nil {
		...
		out.RawString(prefix)
		easyjson8714318cEncodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha17(out, *in.ServiceAccount)
	}
	if in.User != nil {
		const prefix string = ",\"user\":"
		out.RawString(prefix)
		easyjson8714318cEncodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha18(out, *in.User)
	}
	out.RawByte('}')
}
func easyjson8714318cDecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha18(in *jlexer.Lexer, out *UserSubject) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson8714318cEncodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha18(out *jwriter.Writer, in UserSubject) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson8714318cDecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha17(in *jlexer.Lexer, out *ServiceAccountSubject) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson8714318cEncodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha17(out *jwriter.Writer, in ServiceAccountSubject) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson8714318cDecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha16(in *jlexer.Lexer, out *GroupSubject) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson8714318cEncodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha16(out *jwriter.Writer, in GroupSubject) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson8714318cDecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha14(in *jlexer.Lexer, out *ResourcePolicyRule) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson8714318cEncodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha14(out *jwriter.Writer, in ResourcePolicyRule) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson8714318cDecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha13(in *jlexer.Lexer, out *NonResourcePolicyRule) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson8714318cEncodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha13(out *jwriter.Writer, in NonResourcePolicyRule) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson8714318cDecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha11(in *jlexer.Lexer, out *PriorityLevelConfigurationReference) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson8714318cEncodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha11(out *jwriter.Writer, in PriorityLevelConfigurationReference) {
	out.RawByte('{')
	first := true
	_ = first
	{
