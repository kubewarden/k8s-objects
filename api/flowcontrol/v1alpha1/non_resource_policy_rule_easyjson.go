...
func easyjsonD9c99f82DecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha1(in *jlexer.Lexer, out *NonResourcePolicyRule) {
...
func easyjsonD9c99f82EncodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha1(out *jwriter.Writer, in NonResourcePolicyRule) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v NonResourcePolicyRule) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonD9c99f82EncodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha1(&w, v)
...
func (v *NonResourcePolicyRule) UnmarshalJSON(data []byte) error {
	...
	easyjsonD9c99f82DecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *NonResourcePolicyRule) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonD9c99f82DecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha1(l, v)
}
