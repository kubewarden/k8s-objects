...
func easyjsonA8abfc23DecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha1(in *jlexer.Lexer, out *PolicyRulesWithSubjects) {
			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjsonA8abfc23DecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha11(in, v2)
					}
			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjsonA8abfc23DecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha12(in, v3)
					}
...
func easyjsonA8abfc23EncodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha1(out *jwriter.Writer, in PolicyRulesWithSubjects) {
	out.RawByte('{')
	first := true
	_ = first
		...
		}
		{
			...
			for v6, v7 := range in.ResourceRules {
				...
				if v7 == nil {
					...
					easyjsonA8abfc23EncodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha11(out, *v7)
				}
			}
			out.RawByte(']')
		}
		...
		if in.Subjects == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v8, v9 := range in.Subjects {
				...
				if v9 == nil {
					...
					easyjsonA8abfc23EncodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha12(out, *v9)
				}
			}
			out.RawByte(']')
		}
...
func (v PolicyRulesWithSubjects) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonA8abfc23EncodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha1(&w, v)
...
func (v *PolicyRulesWithSubjects) UnmarshalJSON(data []byte) error {
	...
	easyjsonA8abfc23DecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PolicyRulesWithSubjects) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonA8abfc23DecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha1(l, v)
}
func easyjsonA8abfc23DecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha12(in *jlexer.Lexer, out *Subject) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "serviceAccount":
			if in.IsNull() {
				...
				easyjsonA8abfc23DecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha13(in, out.ServiceAccount)
			}
		case "user":
			if in.IsNull() {
				in.Skip()
				...
				easyjsonA8abfc23DecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha14(in, out.User)
			}
		default:
			in.SkipRecursive()
		}
...
func easyjsonA8abfc23EncodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha12(out *jwriter.Writer, in Subject) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Group != nil {
	...
	if in.ServiceAccount != nil {
		...
		out.RawString(prefix)
		easyjsonA8abfc23EncodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha13(out, *in.ServiceAccount)
	}
	if in.User != nil {
		const prefix string = ",\"user\":"
		out.RawString(prefix)
		easyjsonA8abfc23EncodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha14(out, *in.User)
	}
	out.RawByte('}')
}
func easyjsonA8abfc23DecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha14(in *jlexer.Lexer, out *UserSubject) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonA8abfc23EncodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha14(out *jwriter.Writer, in UserSubject) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjsonA8abfc23DecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha13(in *jlexer.Lexer, out *ServiceAccountSubject) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonA8abfc23EncodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha13(out *jwriter.Writer, in ServiceAccountSubject) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjsonA8abfc23DecodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha11(in *jlexer.Lexer, out *ResourcePolicyRule) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonA8abfc23EncodeGithubComKubewardenK8sObjectsApiFlowcontrolV1alpha11(out *jwriter.Writer, in ResourcePolicyRule) {
	out.RawByte('{')
	first := true
	_ = first
	{
