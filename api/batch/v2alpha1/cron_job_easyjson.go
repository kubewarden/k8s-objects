...
func easyjsonA56f4d58DecodeGithubComKubewardenK8sObjectsApiBatchV2alpha1(in *jlexer.Lexer, out *CronJob) {
	...
	for !in.IsDelim('}') {
		...
		case "spec":
			if in.IsNull() {
				...
				easyjsonA56f4d58DecodeGithubComKubewardenK8sObjectsApiBatchV2alpha11(in, out.Spec)
			}
		case "status":
			if in.IsNull() {
				in.Skip()
				...
				easyjsonA56f4d58DecodeGithubComKubewardenK8sObjectsApiBatchV2alpha12(in, out.Status)
			}
		default:
			in.SkipRecursive()
		}
...
func easyjsonA56f4d58EncodeGithubComKubewardenK8sObjectsApiBatchV2alpha1(out *jwriter.Writer, in CronJob) {
	out.RawByte('{')
	first := true
	_ = first
	if in.APIVersion != "" {
	...
	if in.Spec != nil {
		...
		easyjsonA56f4d58EncodeGithubComKubewardenK8sObjectsApiBatchV2alpha11(out, *in.Spec)
	}
	if in.Status != nil {
		...
		easyjsonA56f4d58EncodeGithubComKubewardenK8sObjectsApiBatchV2alpha12(out, *in.Status)
	}
	out.RawByte('}')
}
...
func (v CronJob) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonA56f4d58EncodeGithubComKubewardenK8sObjectsApiBatchV2alpha1(&w, v)
...
func (v *CronJob) UnmarshalJSON(data []byte) error {
	...
	easyjsonA56f4d58DecodeGithubComKubewardenK8sObjectsApiBatchV2alpha1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *CronJob) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonA56f4d58DecodeGithubComKubewardenK8sObjectsApiBatchV2alpha1(l, v)
}
func easyjsonA56f4d58DecodeGithubComKubewardenK8sObjectsApiBatchV2alpha12(in *jlexer.Lexer, out *CronJobStatus) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonA56f4d58EncodeGithubComKubewardenK8sObjectsApiBatchV2alpha12(out *jwriter.Writer, in CronJobStatus) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjsonA56f4d58DecodeGithubComKubewardenK8sObjectsApiBatchV2alpha11(in *jlexer.Lexer, out *CronJobSpec) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "jobTemplate":
			if in.IsNull() {
				...
				easyjsonA56f4d58DecodeGithubComKubewardenK8sObjectsApiBatchV2alpha13(in, out.JobTemplate)
			}
		case "schedule":
			if in.IsNull() {
				in.Skip()
...
func easyjsonA56f4d58EncodeGithubComKubewardenK8sObjectsApiBatchV2alpha11(out *jwriter.Writer, in CronJobSpec) {
	out.RawByte('{')
	first := true
	_ = first
	...
	}
	{
		...
		if in.JobTemplate == nil {
			...
			easyjsonA56f4d58EncodeGithubComKubewardenK8sObjectsApiBatchV2alpha13(out, *in.JobTemplate)
		}
	}
	{
...
func easyjsonA56f4d58DecodeGithubComKubewardenK8sObjectsApiBatchV2alpha13(in *jlexer.Lexer, out *JobTemplateSpec) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonA56f4d58EncodeGithubComKubewardenK8sObjectsApiBatchV2alpha13(out *jwriter.Writer, in JobTemplateSpec) {
	out.RawByte('{')
	first := true
	_ = first
	if true {
