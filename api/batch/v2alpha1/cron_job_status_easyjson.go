...
func easyjson61f92a73DecodeGithubComKubewardenK8sObjectsApiBatchV2alpha1(in *jlexer.Lexer, out *CronJobStatus) {
...
func easyjson61f92a73EncodeGithubComKubewardenK8sObjectsApiBatchV2alpha1(out *jwriter.Writer, in CronJobStatus) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v CronJobStatus) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson61f92a73EncodeGithubComKubewardenK8sObjectsApiBatchV2alpha1(&w, v)
...
func (v *CronJobStatus) UnmarshalJSON(data []byte) error {
	...
	easyjson61f92a73DecodeGithubComKubewardenK8sObjectsApiBatchV2alpha1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *CronJobStatus) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson61f92a73DecodeGithubComKubewardenK8sObjectsApiBatchV2alpha1(l, v)
}
