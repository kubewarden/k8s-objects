...
func easyjson16804a1dDecodeGithubComKubewardenK8sObjectsApiBatchV1(in *jlexer.Lexer, out *JobCondition) {
...
func easyjson16804a1dEncodeGithubComKubewardenK8sObjectsApiBatchV1(out *jwriter.Writer, in JobCondition) {
	out.RawByte('{')
	first := true
	_ = first
	if true {
...
func (v JobCondition) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson16804a1dEncodeGithubComKubewardenK8sObjectsApiBatchV1(&w, v)
...
func (v *JobCondition) UnmarshalJSON(data []byte) error {
	...
	easyjson16804a1dDecodeGithubComKubewardenK8sObjectsApiBatchV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *JobCondition) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson16804a1dDecodeGithubComKubewardenK8sObjectsApiBatchV1(l, v)
}
