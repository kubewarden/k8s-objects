...
func easyjson88b473b4DecodeGithubComKubewardenK8sObjectsApiBatchV1beta1(in *jlexer.Lexer, out *CronJobSpec) {
	...
	for !in.IsDelim('}') {
		...
		case "jobTemplate":
			if in.IsNull() {
				...
				easyjson88b473b4DecodeGithubComKubewardenK8sObjectsApiBatchV1beta11(in, out.JobTemplate)
			}
		case "schedule":
			if in.IsNull() {
				in.Skip()
...
func easyjson88b473b4EncodeGithubComKubewardenK8sObjectsApiBatchV1beta1(out *jwriter.Writer, in CronJobSpec) {
	out.RawByte('{')
	first := true
	_ = first
	...
	}
	{
		...
		if in.JobTemplate == nil {
			...
			easyjson88b473b4EncodeGithubComKubewardenK8sObjectsApiBatchV1beta11(out, *in.JobTemplate)
		}
	}
	{
...
func (v CronJobSpec) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson88b473b4EncodeGithubComKubewardenK8sObjectsApiBatchV1beta1(&w, v)
...
func (v *CronJobSpec) UnmarshalJSON(data []byte) error {
	...
	easyjson88b473b4DecodeGithubComKubewardenK8sObjectsApiBatchV1beta1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *CronJobSpec) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson88b473b4DecodeGithubComKubewardenK8sObjectsApiBatchV1beta1(l, v)
}
func easyjson88b473b4DecodeGithubComKubewardenK8sObjectsApiBatchV1beta11(in *jlexer.Lexer, out *JobTemplateSpec) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson88b473b4EncodeGithubComKubewardenK8sObjectsApiBatchV1beta11(out *jwriter.Writer, in JobTemplateSpec) {
	out.RawByte('{')
	first := true
	_ = first
	if true {
