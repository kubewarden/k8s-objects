...
func easyjson7b5a348aDecodeGithubComKubewardenK8sObjectsApiApiserverinternalV1alpha1(in *jlexer.Lexer, out *StorageVersionCondition) {
...
func easyjson7b5a348aEncodeGithubComKubewardenK8sObjectsApiApiserverinternalV1alpha1(out *jwriter.Writer, in StorageVersionCondition) {
	out.RawByte('{')
	first := true
	_ = first
...
func (v StorageVersionCondition) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson7b5a348aEncodeGithubComKubewardenK8sObjectsApiApiserverinternalV1alpha1(&w, v)
...
func (v *StorageVersionCondition) UnmarshalJSON(data []byte) error {
	...
	easyjson7b5a348aDecodeGithubComKubewardenK8sObjectsApiApiserverinternalV1alpha1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *StorageVersionCondition) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson7b5a348aDecodeGithubComKubewardenK8sObjectsApiApiserverinternalV1alpha1(l, v)
}
