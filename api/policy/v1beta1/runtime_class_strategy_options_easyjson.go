...
func easyjsonC95d9dfcDecodeGithubComKubewardenK8sObjectsApiPolicyV1beta1(in *jlexer.Lexer, out *RuntimeClassStrategyOptions) {
...
func easyjsonC95d9dfcEncodeGithubComKubewardenK8sObjectsApiPolicyV1beta1(out *jwriter.Writer, in RuntimeClassStrategyOptions) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v RuntimeClassStrategyOptions) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonC95d9dfcEncodeGithubComKubewardenK8sObjectsApiPolicyV1beta1(&w, v)
...
func (v *RuntimeClassStrategyOptions) UnmarshalJSON(data []byte) error {
	...
	easyjsonC95d9dfcDecodeGithubComKubewardenK8sObjectsApiPolicyV1beta1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *RuntimeClassStrategyOptions) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonC95d9dfcDecodeGithubComKubewardenK8sObjectsApiPolicyV1beta1(l, v)
}
