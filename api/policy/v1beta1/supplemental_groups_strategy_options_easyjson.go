...
func easyjsonBb83f54DecodeGithubComKubewardenK8sObjectsApiPolicyV1beta1(in *jlexer.Lexer, out *SupplementalGroupsStrategyOptions) {
...
func easyjsonBb83f54EncodeGithubComKubewardenK8sObjectsApiPolicyV1beta1(out *jwriter.Writer, in SupplementalGroupsStrategyOptions) {
	out.RawByte('{')
	first := true
	_ = first
	if len(in.Ranges) != 0 {
...
func (v SupplementalGroupsStrategyOptions) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonBb83f54EncodeGithubComKubewardenK8sObjectsApiPolicyV1beta1(&w, v)
...
func (v *SupplementalGroupsStrategyOptions) UnmarshalJSON(data []byte) error {
	...
	easyjsonBb83f54DecodeGithubComKubewardenK8sObjectsApiPolicyV1beta1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *SupplementalGroupsStrategyOptions) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonBb83f54DecodeGithubComKubewardenK8sObjectsApiPolicyV1beta1(l, v)
}
