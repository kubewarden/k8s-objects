...
func easyjsonE90dabffDecodeGithubComKubewardenK8sObjectsApiPolicyV1beta1(in *jlexer.Lexer, out *PodSecurityPolicySpec) {
	...
	for !in.IsDelim('}') {
		...
		case "runAsGroup":
			if in.IsNull() {
				...
				easyjsonE90dabffDecodeGithubComKubewardenK8sObjectsApiPolicyV1beta11(in, out.RunAsGroup)
			}
		case "runAsUser":
			if in.IsNull() {
				in.Skip()
				...
				easyjsonE90dabffDecodeGithubComKubewardenK8sObjectsApiPolicyV1beta12(in, out.RunAsUser)
			}
		case "runtimeClass":
			if in.IsNull() {
				in.Skip()
				...
				easyjsonE90dabffDecodeGithubComKubewardenK8sObjectsApiPolicyV1beta13(in, out.RuntimeClass)
			}
		case "seLinux":
			if in.IsNull() {
				in.Skip()
				...
				easyjsonE90dabffDecodeGithubComKubewardenK8sObjectsApiPolicyV1beta14(in, out.SELinux)
			}
		case "supplementalGroups":
			if in.IsNull() {
				...
				easyjsonE90dabffDecodeGithubComKubewardenK8sObjectsApiPolicyV1beta15(in, out.SupplementalGroups)
			}
		case "volumes":
			if in.IsNull() {
				in.Skip()
...
func easyjsonE90dabffEncodeGithubComKubewardenK8sObjectsApiPolicyV1beta1(out *jwriter.Writer, in PodSecurityPolicySpec) {
	out.RawByte('{')
	first := true
	_ = first
	...
	if in.RunAsGroup != nil {
		...
		out.RawString(prefix)
		easyjsonE90dabffEncodeGithubComKubewardenK8sObjectsApiPolicyV1beta11(out, *in.RunAsGroup)
	}
	{
		...
		if in.RunAsUser == nil {
			...
			easyjsonE90dabffEncodeGithubComKubewardenK8sObjectsApiPolicyV1beta12(out, *in.RunAsUser)
		}
	}
	if in.RuntimeClass != nil {
		const prefix string = ",\"runtimeClass\":"
		out.RawString(prefix)
		easyjsonE90dabffEncodeGithubComKubewardenK8sObjectsApiPolicyV1beta13(out, *in.RuntimeClass)
	}
	{
		...
		if in.SELinux == nil {
			...
			easyjsonE90dabffEncodeGithubComKubewardenK8sObjectsApiPolicyV1beta14(out, *in.SELinux)
		}
	}
	{
		...
		if in.SupplementalGroups == nil {
			...
			easyjsonE90dabffEncodeGithubComKubewardenK8sObjectsApiPolicyV1beta15(out, *in.SupplementalGroups)
		}
	}
	if len(in.Volumes) != 0 {
...
func (v PodSecurityPolicySpec) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonE90dabffEncodeGithubComKubewardenK8sObjectsApiPolicyV1beta1(&w, v)
...
func (v *PodSecurityPolicySpec) UnmarshalJSON(data []byte) error {
	...
	easyjsonE90dabffDecodeGithubComKubewardenK8sObjectsApiPolicyV1beta1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PodSecurityPolicySpec) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonE90dabffDecodeGithubComKubewardenK8sObjectsApiPolicyV1beta1(l, v)
}
func easyjsonE90dabffDecodeGithubComKubewardenK8sObjectsApiPolicyV1beta15(in *jlexer.Lexer, out *SupplementalGroupsStrategyOptions) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonE90dabffEncodeGithubComKubewardenK8sObjectsApiPolicyV1beta15(out *jwriter.Writer, in SupplementalGroupsStrategyOptions) {
	out.RawByte('{')
	first := true
	_ = first
	if len(in.Ranges) != 0 {
...
func easyjsonE90dabffDecodeGithubComKubewardenK8sObjectsApiPolicyV1beta14(in *jlexer.Lexer, out *SELinuxStrategyOptions) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonE90dabffEncodeGithubComKubewardenK8sObjectsApiPolicyV1beta14(out *jwriter.Writer, in SELinuxStrategyOptions) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjsonE90dabffDecodeGithubComKubewardenK8sObjectsApiPolicyV1beta13(in *jlexer.Lexer, out *RuntimeClassStrategyOptions) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonE90dabffEncodeGithubComKubewardenK8sObjectsApiPolicyV1beta13(out *jwriter.Writer, in RuntimeClassStrategyOptions) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjsonE90dabffDecodeGithubComKubewardenK8sObjectsApiPolicyV1beta12(in *jlexer.Lexer, out *RunAsUserStrategyOptions) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonE90dabffEncodeGithubComKubewardenK8sObjectsApiPolicyV1beta12(out *jwriter.Writer, in RunAsUserStrategyOptions) {
	out.RawByte('{')
	first := true
	_ = first
	if len(in.Ranges) != 0 {
...
func easyjsonE90dabffDecodeGithubComKubewardenK8sObjectsApiPolicyV1beta11(in *jlexer.Lexer, out *RunAsGroupStrategyOptions) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonE90dabffEncodeGithubComKubewardenK8sObjectsApiPolicyV1beta11(out *jwriter.Writer, in RunAsGroupStrategyOptions) {
	out.RawByte('{')
	first := true
	_ = first
	if len(in.Ranges) != 0 {
