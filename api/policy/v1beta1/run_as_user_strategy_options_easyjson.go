...
func easyjson98fd6d23DecodeGithubComKubewardenK8sObjectsApiPolicyV1beta1(in *jlexer.Lexer, out *RunAsUserStrategyOptions) {
...
func easyjson98fd6d23EncodeGithubComKubewardenK8sObjectsApiPolicyV1beta1(out *jwriter.Writer, in RunAsUserStrategyOptions) {
	out.RawByte('{')
	first := true
	_ = first
	if len(in.Ranges) != 0 {
...
func (v RunAsUserStrategyOptions) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson98fd6d23EncodeGithubComKubewardenK8sObjectsApiPolicyV1beta1(&w, v)
...
func (v *RunAsUserStrategyOptions) UnmarshalJSON(data []byte) error {
	...
	easyjson98fd6d23DecodeGithubComKubewardenK8sObjectsApiPolicyV1beta1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *RunAsUserStrategyOptions) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson98fd6d23DecodeGithubComKubewardenK8sObjectsApiPolicyV1beta1(l, v)
}
