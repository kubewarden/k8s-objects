...
func easyjsonA0ab071cDecodeGithubComKubewardenK8sObjectsApiPolicyV1beta1(in *jlexer.Lexer, out *SELinuxStrategyOptions) {
...
func easyjsonA0ab071cEncodeGithubComKubewardenK8sObjectsApiPolicyV1beta1(out *jwriter.Writer, in SELinuxStrategyOptions) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v SELinuxStrategyOptions) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonA0ab071cEncodeGithubComKubewardenK8sObjectsApiPolicyV1beta1(&w, v)
...
func (v *SELinuxStrategyOptions) UnmarshalJSON(data []byte) error {
	...
	easyjsonA0ab071cDecodeGithubComKubewardenK8sObjectsApiPolicyV1beta1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *SELinuxStrategyOptions) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonA0ab071cDecodeGithubComKubewardenK8sObjectsApiPolicyV1beta1(l, v)
}
