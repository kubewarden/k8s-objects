	...
	for !in.IsDelim('}') {
		...
		case "seLinux":
			if in.IsNull() {
				...
				easyjsonA70dd7d9DecodeGithubComKubewardenK8sObjectsApiPolicyV1beta14(in, out.SeLinux)
			}
		case "supplementalGroups":
			if in.IsNull() {
				...
				easyjsonA70dd7d9DecodeGithubComKubewardenK8sObjectsApiPolicyV1beta15(in, out.SupplementalGroups)
			}
		case "volumes":
			if in.IsNull() {
				in.Skip()
...
func easyjsonA70dd7d9EncodeGithubComKubewardenK8sObjectsApiPolicyV1beta11(out *jwriter.Writer, in PodSecurityPolicySpec) {
	...
	}
	{
		...
		if in.SeLinux == nil {
			...
			easyjsonA70dd7d9EncodeGithubComKubewardenK8sObjectsApiPolicyV1beta14(out, *in.SeLinux)
		}
	}
	{
		...
		if in.SupplementalGroups == nil {
			...
			easyjsonA70dd7d9EncodeGithubComKubewardenK8sObjectsApiPolicyV1beta15(out, *in.SupplementalGroups)
		}
	}
	if len(in.Volumes) != 0 {
...
func easyjsonA70dd7d9DecodeGithubComKubewardenK8sObjectsApiPolicyV1beta15(in *jlexer.Lexer, out *SupplementalGroupsStrategyOptions) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonA70dd7d9EncodeGithubComKubewardenK8sObjectsApiPolicyV1beta15(out *jwriter.Writer, in SupplementalGroupsStrategyOptions) {
	out.RawByte('{')
	first := true
	_ = first
	if len(in.Ranges) != 0 {
...
func easyjsonA70dd7d9DecodeGithubComKubewardenK8sObjectsApiPolicyV1beta14(in *jlexer.Lexer, out *SELinuxStrategyOptions) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonA70dd7d9EncodeGithubComKubewardenK8sObjectsApiPolicyV1beta14(out *jwriter.Writer, in SELinuxStrategyOptions) {
	out.RawByte('{')
	first := true
	_ = first
	{
