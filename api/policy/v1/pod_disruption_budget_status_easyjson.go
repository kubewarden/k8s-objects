...
func easyjsonAe15a9caDecodeGithubComKubewardenK8sObjectsApiPolicyV1(in *jlexer.Lexer, out *PodDisruptionBudgetStatus) {
...
func easyjsonAe15a9caEncodeGithubComKubewardenK8sObjectsApiPolicyV1(out *jwriter.Writer, in PodDisruptionBudgetStatus) {
	out.RawByte('{')
	first := true
	_ = first
...
func (v PodDisruptionBudgetStatus) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonAe15a9caEncodeGithubComKubewardenK8sObjectsApiPolicyV1(&w, v)
...
func (v *PodDisruptionBudgetStatus) UnmarshalJSON(data []byte) error {
	...
	easyjsonAe15a9caDecodeGithubComKubewardenK8sObjectsApiPolicyV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PodDisruptionBudgetStatus) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonAe15a9caDecodeGithubComKubewardenK8sObjectsApiPolicyV1(l, v)
}
