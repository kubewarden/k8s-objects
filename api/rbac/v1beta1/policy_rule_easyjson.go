...
func easyjsonD6e22eadDecodeGithubComKubewardenK8sObjectsApiRbacV1beta1(in *jlexer.Lexer, out *PolicyRule) {
...
func easyjsonD6e22eadEncodeGithubComKubewardenK8sObjectsApiRbacV1beta1(out *jwriter.Writer, in PolicyRule) {
	out.RawByte('{')
	first := true
	_ = first
...
func (v PolicyRule) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonD6e22eadEncodeGithubComKubewardenK8sObjectsApiRbacV1beta1(&w, v)
...
func (v *PolicyRule) UnmarshalJSON(data []byte) error {
	...
	easyjsonD6e22eadDecodeGithubComKubewardenK8sObjectsApiRbacV1beta1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PolicyRule) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonD6e22eadDecodeGithubComKubewardenK8sObjectsApiRbacV1beta1(l, v)
}
