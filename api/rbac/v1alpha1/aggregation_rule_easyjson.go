...
func easyjsonFf257cb3DecodeGithubComKubewardenK8sObjectsApiRbacV1alpha1(in *jlexer.Lexer, out *AggregationRule) {
...
func easyjsonFf257cb3EncodeGithubComKubewardenK8sObjectsApiRbacV1alpha1(out *jwriter.Writer, in AggregationRule) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v AggregationRule) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonFf257cb3EncodeGithubComKubewardenK8sObjectsApiRbacV1alpha1(&w, v)
...
func (v *AggregationRule) UnmarshalJSON(data []byte) error {
	...
	easyjsonFf257cb3DecodeGithubComKubewardenK8sObjectsApiRbacV1alpha1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *AggregationRule) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonFf257cb3DecodeGithubComKubewardenK8sObjectsApiRbacV1alpha1(l, v)
}
