...
func easyjson3aa86ec1DecodeGithubComKubewardenK8sObjectsApiRbacV1alpha1(in *jlexer.Lexer, out *ClusterRole) {
			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjson3aa86ec1DecodeGithubComKubewardenK8sObjectsApiRbacV1alpha11(in, v1)
					}
...
func easyjson3aa86ec1EncodeGithubComKubewardenK8sObjectsApiRbacV1alpha1(out *jwriter.Writer, in ClusterRole) {
	out.RawByte('{')
	first := true
	_ = first
		...
		}
		{
			...
			for v2, v3 := range in.Rules {
				...
				if v3 == nil {
					...
					easyjson3aa86ec1EncodeGithubComKubewardenK8sObjectsApiRbacV1alpha11(out, *v3)
				}
			}
			out.RawByte(']')
		}
...
func (v ClusterRole) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson3aa86ec1EncodeGithubComKubewardenK8sObjectsApiRbacV1alpha1(&w, v)
...
func (v *ClusterRole) UnmarshalJSON(data []byte) error {
	...
	easyjson3aa86ec1DecodeGithubComKubewardenK8sObjectsApiRbacV1alpha1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *ClusterRole) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson3aa86ec1DecodeGithubComKubewardenK8sObjectsApiRbacV1alpha1(l, v)
}
func easyjson3aa86ec1DecodeGithubComKubewardenK8sObjectsApiRbacV1alpha11(in *jlexer.Lexer, out *PolicyRule) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson3aa86ec1EncodeGithubComKubewardenK8sObjectsApiRbacV1alpha11(out *jwriter.Writer, in PolicyRule) {
	out.RawByte('{')
	first := true
	_ = first
