...
func easyjson80489276DecodeGithubComKubewardenK8sObjectsApiExtensionsV1beta1(in *jlexer.Lexer, out *ReplicaSetStatus) {
...
func easyjson80489276EncodeGithubComKubewardenK8sObjectsApiExtensionsV1beta1(out *jwriter.Writer, in ReplicaSetStatus) {
	out.RawByte('{')
	first := true
	_ = first
...
func (v ReplicaSetStatus) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson80489276EncodeGithubComKubewardenK8sObjectsApiExtensionsV1beta1(&w, v)
...
func (v *ReplicaSetStatus) UnmarshalJSON(data []byte) error {
	...
	easyjson80489276DecodeGithubComKubewardenK8sObjectsApiExtensionsV1beta1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *ReplicaSetStatus) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson80489276DecodeGithubComKubewardenK8sObjectsApiExtensionsV1beta1(l, v)
}
