...
func easyjsonFb0f9111DecodeGithubComKubewardenK8sObjectsApiExtensionsV1beta1(in *jlexer.Lexer, out *NetworkPolicySpec) {
...
func easyjsonFb0f9111EncodeGithubComKubewardenK8sObjectsApiExtensionsV1beta1(out *jwriter.Writer, in NetworkPolicySpec) {
	out.RawByte('{')
	first := true
	_ = first
	if len(in.Egress) != 0 {
...
func (v NetworkPolicySpec) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonFb0f9111EncodeGithubComKubewardenK8sObjectsApiExtensionsV1beta1(&w, v)
...
func (v *NetworkPolicySpec) UnmarshalJSON(data []byte) error {
	...
	easyjsonFb0f9111DecodeGithubComKubewardenK8sObjectsApiExtensionsV1beta1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *NetworkPolicySpec) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonFb0f9111DecodeGithubComKubewardenK8sObjectsApiExtensionsV1beta1(l, v)
}
