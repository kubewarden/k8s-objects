...
func easyjson76958710DecodeGithubComKubewardenK8sObjectsApiExtensionsV1beta1(in *jlexer.Lexer, out *NetworkPolicyPeer) {
...
func easyjson76958710EncodeGithubComKubewardenK8sObjectsApiExtensionsV1beta1(out *jwriter.Writer, in NetworkPolicyPeer) {
	out.RawByte('{')
	first := true
	_ = first
	if in.IPBlock != nil {
...
func (v NetworkPolicyPeer) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson76958710EncodeGithubComKubewardenK8sObjectsApiExtensionsV1beta1(&w, v)
...
func (v *NetworkPolicyPeer) UnmarshalJSON(data []byte) error {
	...
	easyjson76958710DecodeGithubComKubewardenK8sObjectsApiExtensionsV1beta1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *NetworkPolicyPeer) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson76958710DecodeGithubComKubewardenK8sObjectsApiExtensionsV1beta1(l, v)
}
