...
func easyjsonE6692ddbDecodeGithubComKubewardenK8sObjectsApiExtensionsV1beta1(in *jlexer.Lexer, out *RollingUpdateDeployment) {
...
func easyjsonE6692ddbEncodeGithubComKubewardenK8sObjectsApiExtensionsV1beta1(out *jwriter.Writer, in RollingUpdateDeployment) {
	out.RawByte('{')
	first := true
	_ = first
	if in.MaxSurge != nil {
...
func (v RollingUpdateDeployment) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonE6692ddbEncodeGithubComKubewardenK8sObjectsApiExtensionsV1beta1(&w, v)
...
func (v *RollingUpdateDeployment) UnmarshalJSON(data []byte) error {
	...
	easyjsonE6692ddbDecodeGithubComKubewardenK8sObjectsApiExtensionsV1beta1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *RollingUpdateDeployment) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonE6692ddbDecodeGithubComKubewardenK8sObjectsApiExtensionsV1beta1(l, v)
}
