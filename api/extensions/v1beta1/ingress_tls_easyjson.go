...
func easyjson4b11041dDecodeGithubComKubewardenK8sObjectsApiExtensionsV1beta1(in *jlexer.Lexer, out *IngressTLS) {
...
func easyjson4b11041dEncodeGithubComKubewardenK8sObjectsApiExtensionsV1beta1(out *jwriter.Writer, in IngressTLS) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v IngressTLS) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson4b11041dEncodeGithubComKubewardenK8sObjectsApiExtensionsV1beta1(&w, v)
...
func (v *IngressTLS) UnmarshalJSON(data []byte) error {
	...
	easyjson4b11041dDecodeGithubComKubewardenK8sObjectsApiExtensionsV1beta1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *IngressTLS) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson4b11041dDecodeGithubComKubewardenK8sObjectsApiExtensionsV1beta1(l, v)
}
