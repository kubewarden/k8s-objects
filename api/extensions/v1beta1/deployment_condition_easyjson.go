...
func easyjson7ddec57fDecodeGithubComKubewardenK8sObjectsApiExtensionsV1beta1(in *jlexer.Lexer, out *DeploymentCondition) {
...
func easyjson7ddec57fEncodeGithubComKubewardenK8sObjectsApiExtensionsV1beta1(out *jwriter.Writer, in DeploymentCondition) {
	out.RawByte('{')
	first := true
	_ = first
	if true {
...
func (v DeploymentCondition) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson7ddec57fEncodeGithubComKubewardenK8sObjectsApiExtensionsV1beta1(&w, v)
...
func (v *DeploymentCondition) UnmarshalJSON(data []byte) error {
	...
	easyjson7ddec57fDecodeGithubComKubewardenK8sObjectsApiExtensionsV1beta1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *DeploymentCondition) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson7ddec57fDecodeGithubComKubewardenK8sObjectsApiExtensionsV1beta1(l, v)
}
