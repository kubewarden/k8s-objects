	...
	for !in.IsDelim('}') {
		...
		case "seLinux":
			if in.IsNull() {
				...
				easyjsonE90dabffDecodeGithubComKubewardenK8sObjectsApiExtensionsV1beta13(in, out.SELinux)
			}
		case "supplementalGroups":
			if in.IsNull() {
				...
				easyjsonE90dabffDecodeGithubComKubewardenK8sObjectsApiExtensionsV1beta14(in, out.SupplementalGroups)
			}
		case "volumes":
			if in.IsNull() {
				in.Skip()
...
func easyjsonE90dabffEncodeGithubComKubewardenK8sObjectsApiExtensionsV1beta1(out *jwriter.Writer, in PodSecurityPolicySpec) {
	...
	}
	{
		...
		if in.SELinux == nil {
			...
			easyjsonE90dabffEncodeGithubComKubewardenK8sObjectsApiExtensionsV1beta13(out, *in.SELinux)
		}
	}
	{
		...
		if in.SupplementalGroups == nil {
			...
			easyjsonE90dabffEncodeGithubComKubewardenK8sObjectsApiExtensionsV1beta14(out, *in.SupplementalGroups)
		}
	}
	if len(in.Volumes) != 0 {
...
func easyjsonE90dabffDecodeGithubComKubewardenK8sObjectsApiExtensionsV1beta14(in *jlexer.Lexer, out *SupplementalGroupsStrategyOptions) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonE90dabffEncodeGithubComKubewardenK8sObjectsApiExtensionsV1beta14(out *jwriter.Writer, in SupplementalGroupsStrategyOptions) {
	out.RawByte('{')
	first := true
	_ = first
	if len(in.Ranges) != 0 {
...
func easyjsonE90dabffDecodeGithubComKubewardenK8sObjectsApiExtensionsV1beta13(in *jlexer.Lexer, out *SELinuxStrategyOptions) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonE90dabffEncodeGithubComKubewardenK8sObjectsApiExtensionsV1beta13(out *jwriter.Writer, in SELinuxStrategyOptions) {
	out.RawByte('{')
	first := true
	_ = first
	{
