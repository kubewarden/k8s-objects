...
func easyjsonE311e2eeDecodeGithubComKubewardenK8sObjectsApiAuthorizationV1beta1(in *jlexer.Lexer, out *ResourceAttributes) {
...
func easyjsonE311e2eeEncodeGithubComKubewardenK8sObjectsApiAuthorizationV1beta1(out *jwriter.Writer, in ResourceAttributes) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Group != "" {
...
func (v ResourceAttributes) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonE311e2eeEncodeGithubComKubewardenK8sObjectsApiAuthorizationV1beta1(&w, v)
...
func (v *ResourceAttributes) UnmarshalJSON(data []byte) error {
	...
	easyjsonE311e2eeDecodeGithubComKubewardenK8sObjectsApiAuthorizationV1beta1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *ResourceAttributes) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonE311e2eeDecodeGithubComKubewardenK8sObjectsApiAuthorizationV1beta1(l, v)
}
