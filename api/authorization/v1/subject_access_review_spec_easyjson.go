...
func easyjsonDb6d2716DecodeGithubComKubewardenK8sObjectsApiAuthorizationV1(in *jlexer.Lexer, out *SubjectAccessReviewSpec) {
...
func easyjsonDb6d2716EncodeGithubComKubewardenK8sObjectsApiAuthorizationV1(out *jwriter.Writer, in SubjectAccessReviewSpec) {
	out.RawByte('{')
	first := true
	_ = first
	if len(in.Extra) != 0 {
...
func (v SubjectAccessReviewSpec) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonDb6d2716EncodeGithubComKubewardenK8sObjectsApiAuthorizationV1(&w, v)
...
func (v *SubjectAccessReviewSpec) UnmarshalJSON(data []byte) error {
	...
	easyjsonDb6d2716DecodeGithubComKubewardenK8sObjectsApiAuthorizationV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *SubjectAccessReviewSpec) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonDb6d2716DecodeGithubComKubewardenK8sObjectsApiAuthorizationV1(l, v)
}
