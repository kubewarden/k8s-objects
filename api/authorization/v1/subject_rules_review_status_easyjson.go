...
func easyjsonAe3f4c9aDecodeGithubComKubewardenK8sObjectsApiAuthorizationV1(in *jlexer.Lexer, out *SubjectRulesReviewStatus) {
...
func easyjsonAe3f4c9aEncodeGithubComKubewardenK8sObjectsApiAuthorizationV1(out *jwriter.Writer, in SubjectRulesReviewStatus) {
	out.RawByte('{')
	first := true
	_ = first
...
func (v SubjectRulesReviewStatus) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonAe3f4c9aEncodeGithubComKubewardenK8sObjectsApiAuthorizationV1(&w, v)
...
func (v *SubjectRulesReviewStatus) UnmarshalJSON(data []byte) error {
	...
	easyjsonAe3f4c9aDecodeGithubComKubewardenK8sObjectsApiAuthorizationV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *SubjectRulesReviewStatus) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonAe3f4c9aDecodeGithubComKubewardenK8sObjectsApiAuthorizationV1(l, v)
}
