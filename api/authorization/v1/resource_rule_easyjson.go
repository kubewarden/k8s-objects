...
func easyjson39ff2ff3DecodeGithubComKubewardenK8sObjectsApiAuthorizationV1(in *jlexer.Lexer, out *ResourceRule) {
...
func easyjson39ff2ff3EncodeGithubComKubewardenK8sObjectsApiAuthorizationV1(out *jwriter.Writer, in ResourceRule) {
	out.RawByte('{')
	first := true
	_ = first
...
func (v ResourceRule) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson39ff2ff3EncodeGithubComKubewardenK8sObjectsApiAuthorizationV1(&w, v)
...
func (v *ResourceRule) UnmarshalJSON(data []byte) error {
	...
	easyjson39ff2ff3DecodeGithubComKubewardenK8sObjectsApiAuthorizationV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *ResourceRule) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson39ff2ff3DecodeGithubComKubewardenK8sObjectsApiAuthorizationV1(l, v)
}
