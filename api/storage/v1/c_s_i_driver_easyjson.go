...
func easyjson86ba675aDecodeGithubComKubewardenK8sObjectsApiStorageV1(in *jlexer.Lexer, out *CSIDriver) {
	...
	for !in.IsDelim('}') {
		...
		case "spec":
			if in.IsNull() {
				...
				easyjson86ba675aDecodeGithubComKubewardenK8sObjectsApiStorageV11(in, out.Spec)
			}
		default:
			in.SkipRecursive()
		}
...
func easyjson86ba675aEncodeGithubComKubewardenK8sObjectsApiStorageV1(out *jwriter.Writer, in CSIDriver) {
	out.RawByte('{')
	first := true
	_ = first
	if in.APIVersion != "" {
	...
	}
	{
		...
		if in.Spec == nil {
			...
			easyjson86ba675aEncodeGithubComKubewardenK8sObjectsApiStorageV11(out, *in.Spec)
		}
	}
	out.RawByte('}')
}
...
func (v CSIDriver) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson86ba675aEncodeGithubComKubewardenK8sObjectsApiStorageV1(&w, v)
...
func (v *CSIDriver) UnmarshalJSON(data []byte) error {
	...
	easyjson86ba675aDecodeGithubComKubewardenK8sObjectsApiStorageV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *CSIDriver) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson86ba675aDecodeGithubComKubewardenK8sObjectsApiStorageV1(l, v)
}
func easyjson86ba675aDecodeGithubComKubewardenK8sObjectsApiStorageV11(in *jlexer.Lexer, out *CSIDriverSpec) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjson86ba675aDecodeGithubComKubewardenK8sObjectsApiStorageV12(in, v1)
					}
...
func easyjson86ba675aEncodeGithubComKubewardenK8sObjectsApiStorageV11(out *jwriter.Writer, in CSIDriverSpec) {
	out.RawByte('{')
	first := true
	_ = first
		...
		}
		{
			...
			for v3, v4 := range in.TokenRequests {
				...
				if v4 == nil {
					...
					easyjson86ba675aEncodeGithubComKubewardenK8sObjectsApiStorageV12(out, *v4)
				}
			}
			out.RawByte(']')
		}
...
func easyjson86ba675aDecodeGithubComKubewardenK8sObjectsApiStorageV12(in *jlexer.Lexer, out *TokenRequest) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson86ba675aEncodeGithubComKubewardenK8sObjectsApiStorageV12(out *jwriter.Writer, in TokenRequest) {
	out.RawByte('{')
	first := true
	_ = first
	{
