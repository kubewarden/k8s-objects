			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjson7ec52420DecodeGithubComKubewardenK8sObjectsApiStorageV11(in, v1)
					}
		...
		}
		{
			...
			for v3, v4 := range in.TokenRequests {
				...
				if v4 == nil {
					...
					easyjson7ec52420EncodeGithubComKubewardenK8sObjectsApiStorageV11(out, *v4)
				}
			}
			out.RawByte(']')
		}
...
func easyjson7ec52420DecodeGithubComKubewardenK8sObjectsApiStorageV11(in *jlexer.Lexer, out *TokenRequest) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson7ec52420EncodeGithubComKubewardenK8sObjectsApiStorageV11(out *jwriter.Writer, in TokenRequest) {
	out.RawByte('{')
	first := true
	_ = first
	{
