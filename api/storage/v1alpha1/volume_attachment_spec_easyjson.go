...
func easyjsonB50f7d14DecodeGithubComKubewardenK8sObjectsApiStorageV1alpha1(in *jlexer.Lexer, out *VolumeAttachmentSpec) {
...
func easyjsonB50f7d14EncodeGithubComKubewardenK8sObjectsApiStorageV1alpha1(out *jwriter.Writer, in VolumeAttachmentSpec) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v VolumeAttachmentSpec) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonB50f7d14EncodeGithubComKubewardenK8sObjectsApiStorageV1alpha1(&w, v)
...
func (v *VolumeAttachmentSpec) UnmarshalJSON(data []byte) error {
	...
	easyjsonB50f7d14DecodeGithubComKubewardenK8sObjectsApiStorageV1alpha1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *VolumeAttachmentSpec) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonB50f7d14DecodeGithubComKubewardenK8sObjectsApiStorageV1alpha1(l, v)
}
