	...
	for !in.IsDelim('}') {
		...
		case "allocatable":
			if in.IsNull() {
				...
				easyjson4188fa4DecodeGithubComKubewardenK8sObjectsApiStorageV1beta13(in, out.Allocatable)
			}
		case "name":
			if in.IsNull() {
				in.Skip()
...
func easyjson4188fa4EncodeGithubComKubewardenK8sObjectsApiStorageV1beta12(out *jwriter.Writer, in CSINodeDriver) {
	...
	if in.Allocatable != nil {
		...
		first = false
		out.RawString(prefix[1:])
		easyjson4188fa4EncodeGithubComKubewardenK8sObjectsApiStorageV1beta13(out, *in.Allocatable)
	}
	{
...
func easyjson4188fa4DecodeGithubComKubewardenK8sObjectsApiStorageV1beta13(in *jlexer.Lexer, out *VolumeNodeResources) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson4188fa4EncodeGithubComKubewardenK8sObjectsApiStorageV1beta13(out *jwriter.Writer, in VolumeNodeResources) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Count != 0 {
