			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjson86ba675aDecodeGithubComKubewardenK8sObjectsApiStorageV1beta12(in, v1)
					}
		...
		if in.TokenRequests == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v3, v4 := range in.TokenRequests {
				...
				if v4 == nil {
					...
					easyjson86ba675aEncodeGithubComKubewardenK8sObjectsApiStorageV1beta12(out, *v4)
				}
			}
			out.RawByte(']')
		}
...
func easyjson86ba675aDecodeGithubComKubewardenK8sObjectsApiStorageV1beta12(in *jlexer.Lexer, out *TokenRequest) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson86ba675aEncodeGithubComKubewardenK8sObjectsApiStorageV1beta12(out *jwriter.Writer, in TokenRequest) {
	out.RawByte('{')
	first := true
	_ = first
	{
