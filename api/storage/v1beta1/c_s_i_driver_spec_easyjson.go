...
func easyjsonEdb00d66DecodeGithubComKubewardenK8sObjectsApiStorageV1beta1(in *jlexer.Lexer, out *CSIDriverSpec) {
			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjsonEdb00d66DecodeGithubComKubewardenK8sObjectsApiStorageV1beta11(in, v1)
					}
...
func easyjsonEdb00d66EncodeGithubComKubewardenK8sObjectsApiStorageV1beta1(out *jwriter.Writer, in CSIDriverSpec) {
	out.RawByte('{')
	first := true
	_ = first
		...
		if in.TokenRequests == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v3, v4 := range in.TokenRequests {
				...
				if v4 == nil {
					...
					easyjsonEdb00d66EncodeGithubComKubewardenK8sObjectsApiStorageV1beta11(out, *v4)
				}
			}
			out.RawByte(']')
		}
...
func (v CSIDriverSpec) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonEdb00d66EncodeGithubComKubewardenK8sObjectsApiStorageV1beta1(&w, v)
...
func (v *CSIDriverSpec) UnmarshalJSON(data []byte) error {
	...
	easyjsonEdb00d66DecodeGithubComKubewardenK8sObjectsApiStorageV1beta1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *CSIDriverSpec) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonEdb00d66DecodeGithubComKubewardenK8sObjectsApiStorageV1beta1(l, v)
}
func easyjsonEdb00d66DecodeGithubComKubewardenK8sObjectsApiStorageV1beta11(in *jlexer.Lexer, out *TokenRequest) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonEdb00d66EncodeGithubComKubewardenK8sObjectsApiStorageV1beta11(out *jwriter.Writer, in TokenRequest) {
	out.RawByte('{')
	first := true
	_ = first
	{
