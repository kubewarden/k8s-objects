	...
	for !in.IsDelim('}') {
		...
		case "allocatable":
			if in.IsNull() {
				...
				easyjson27007753DecodeGithubComKubewardenK8sObjectsApiStorageV1beta11(in, out.Allocatable)
			}
		case "name":
			if in.IsNull() {
				in.Skip()
...
func easyjson27007753EncodeGithubComKubewardenK8sObjectsApiStorageV1beta1(out *jwriter.Writer, in CSINodeDriver) {
	...
	if in.Allocatable != nil {
		...
		easyjson27007753EncodeGithubComKubewardenK8sObjectsApiStorageV1beta11(out, *in.Allocatable)
	}
	{
...
func easyjson27007753DecodeGithubComKubewardenK8sObjectsApiStorageV1beta11(in *jlexer.Lexer, out *VolumeNodeResources) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson27007753EncodeGithubComKubewardenK8sObjectsApiStorageV1beta11(out *jwriter.Writer, in VolumeNodeResources) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Count != 0 {
