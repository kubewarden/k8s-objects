...
func easyjsonA029cd11DecodeGithubComKubewardenK8sObjectsApiAutoscalingV2(in *jlexer.Lexer, out *HPAScalingRules) {
...
func easyjsonA029cd11EncodeGithubComKubewardenK8sObjectsApiAutoscalingV2(out *jwriter.Writer, in HPAScalingRules) {
	out.RawByte('{')
	first := true
	_ = first
...
func (v HPAScalingRules) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonA029cd11EncodeGithubComKubewardenK8sObjectsApiAutoscalingV2(&w, v)
...
func (v *HPAScalingRules) UnmarshalJSON(data []byte) error {
	...
	easyjsonA029cd11DecodeGithubComKubewardenK8sObjectsApiAutoscalingV2(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *HPAScalingRules) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonA029cd11DecodeGithubComKubewardenK8sObjectsApiAutoscalingV2(l, v)
}
