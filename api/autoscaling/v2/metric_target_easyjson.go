...
func easyjson122a1cdeDecodeGithubComKubewardenK8sObjectsApiAutoscalingV2(in *jlexer.Lexer, out *MetricTarget) {
...
func easyjson122a1cdeEncodeGithubComKubewardenK8sObjectsApiAutoscalingV2(out *jwriter.Writer, in MetricTarget) {
	out.RawByte('{')
	first := true
	_ = first
...
func (v MetricTarget) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson122a1cdeEncodeGithubComKubewardenK8sObjectsApiAutoscalingV2(&w, v)
...
func (v *MetricTarget) UnmarshalJSON(data []byte) error {
	...
	easyjson122a1cdeDecodeGithubComKubewardenK8sObjectsApiAutoscalingV2(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *MetricTarget) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson122a1cdeDecodeGithubComKubewardenK8sObjectsApiAutoscalingV2(l, v)
}
