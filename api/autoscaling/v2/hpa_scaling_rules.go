...
// HPAScalingRules HPAScalingRules configures the scaling behavior for one direction via scaling Policy Rules and a configurable metric tolerance.
//
...
type HPAScalingRules struct {
	...
	Tolerance *apimachinery_pkg_api_resource.Quantity `json:"tolerance,omitempty"`
}
