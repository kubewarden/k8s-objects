...
func easyjson1d7c9f89DecodeGithubComKubewardenK8sObjectsApiAutoscalingV2(in *jlexer.Lexer, out *ContainerResourceMetricSource) {
	...
	for !in.IsDelim('}') {
		...
		case "target":
			if in.IsNull() {
				...
				easyjson1d7c9f89DecodeGithubComKubewardenK8sObjectsApiAutoscalingV21(in, out.Target)
			}
		default:
			in.SkipRecursive()
		}
...
func easyjson1d7c9f89EncodeGithubComKubewardenK8sObjectsApiAutoscalingV2(out *jwriter.Writer, in ContainerResourceMetricSource) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		if in.Target == nil {
			...
			easyjson1d7c9f89EncodeGithubComKubewardenK8sObjectsApiAutoscalingV21(out, *in.Target)
		}
	}
	out.RawByte('}')
}
...
func (v ContainerResourceMetricSource) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson1d7c9f89EncodeGithubComKubewardenK8sObjectsApiAutoscalingV2(&w, v)
...
func (v *ContainerResourceMetricSource) UnmarshalJSON(data []byte) error {
	...
	easyjson1d7c9f89DecodeGithubComKubewardenK8sObjectsApiAutoscalingV2(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *ContainerResourceMetricSource) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson1d7c9f89DecodeGithubComKubewardenK8sObjectsApiAutoscalingV2(l, v)
}
func easyjson1d7c9f89DecodeGithubComKubewardenK8sObjectsApiAutoscalingV21(in *jlexer.Lexer, out *MetricTarget) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson1d7c9f89EncodeGithubComKubewardenK8sObjectsApiAutoscalingV21(out *jwriter.Writer, in MetricTarget) {
	out.RawByte('{')
	first := true
	_ = first
