...
func easyjson72e00752DecodeGithubComKubewardenK8sObjectsApiAutoscalingV2(in *jlexer.Lexer, out *HorizontalPodAutoscalerCondition) {
...
func easyjson72e00752EncodeGithubComKubewardenK8sObjectsApiAutoscalingV2(out *jwriter.Writer, in HorizontalPodAutoscalerCondition) {
	out.RawByte('{')
	first := true
	_ = first
...
func (v HorizontalPodAutoscalerCondition) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson72e00752EncodeGithubComKubewardenK8sObjectsApiAutoscalingV2(&w, v)
...
func (v *HorizontalPodAutoscalerCondition) UnmarshalJSON(data []byte) error {
	...
	easyjson72e00752DecodeGithubComKubewardenK8sObjectsApiAutoscalingV2(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *HorizontalPodAutoscalerCondition) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson72e00752DecodeGithubComKubewardenK8sObjectsApiAutoscalingV2(l, v)
}
