...
func easyjson8d0d2808DecodeGithubComKubewardenK8sObjectsApiAutoscalingV2(in *jlexer.Lexer, out *ContainerResourceMetricStatus) {
	...
	for !in.IsDelim('}') {
		...
		case "current":
			if in.IsNull() {
				...
				easyjson8d0d2808DecodeGithubComKubewardenK8sObjectsApiAutoscalingV21(in, out.Current)
			}
		case "name":
			if in.IsNull() {
				in.Skip()
...
func easyjson8d0d2808EncodeGithubComKubewardenK8sObjectsApiAutoscalingV2(out *jwriter.Writer, in ContainerResourceMetricStatus) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		if in.Current == nil {
			...
			easyjson8d0d2808EncodeGithubComKubewardenK8sObjectsApiAutoscalingV21(out, *in.Current)
		}
	}
	{
...
func (v ContainerResourceMetricStatus) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson8d0d2808EncodeGithubComKubewardenK8sObjectsApiAutoscalingV2(&w, v)
...
func (v *ContainerResourceMetricStatus) UnmarshalJSON(data []byte) error {
	...
	easyjson8d0d2808DecodeGithubComKubewardenK8sObjectsApiAutoscalingV2(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *ContainerResourceMetricStatus) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson8d0d2808DecodeGithubComKubewardenK8sObjectsApiAutoscalingV2(l, v)
}
func easyjson8d0d2808DecodeGithubComKubewardenK8sObjectsApiAutoscalingV21(in *jlexer.Lexer, out *MetricValueStatus) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson8d0d2808EncodeGithubComKubewardenK8sObjectsApiAutoscalingV21(out *jwriter.Writer, in MetricValueStatus) {
	out.RawByte('{')
	first := true
	_ = first
