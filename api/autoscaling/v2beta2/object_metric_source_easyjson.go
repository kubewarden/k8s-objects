...
func easyjsonE86a02c4DecodeGithubComKubewardenK8sObjectsApiAutoscalingV2beta2(in *jlexer.Lexer, out *ObjectMetricSource) {
...
func easyjsonE86a02c4EncodeGithubComKubewardenK8sObjectsApiAutoscalingV2beta2(out *jwriter.Writer, in ObjectMetricSource) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v ObjectMetricSource) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonE86a02c4EncodeGithubComKubewardenK8sObjectsApiAutoscalingV2beta2(&w, v)
...
func (v *ObjectMetricSource) UnmarshalJSON(data []byte) error {
	...
	easyjsonE86a02c4DecodeGithubComKubewardenK8sObjectsApiAutoscalingV2beta2(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *ObjectMetricSource) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonE86a02c4DecodeGithubComKubewardenK8sObjectsApiAutoscalingV2beta2(l, v)
}
