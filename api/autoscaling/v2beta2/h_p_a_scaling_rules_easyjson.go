...
func easyjson320b3e1DecodeGithubComKubewardenK8sObjectsApiAutoscalingV2beta2(in *jlexer.Lexer, out *HPAScalingRules) {
...
func easyjson320b3e1EncodeGithubComKubewardenK8sObjectsApiAutoscalingV2beta2(out *jwriter.Writer, in HPAScalingRules) {
	out.RawByte('{')
	first := true
	_ = first
...
func (v HPAScalingRules) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson320b3e1EncodeGithubComKubewardenK8sObjectsApiAutoscalingV2beta2(&w, v)
...
func (v *HPAScalingRules) UnmarshalJSON(data []byte) error {
	...
	easyjson320b3e1DecodeGithubComKubewardenK8sObjectsApiAutoscalingV2beta2(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *HPAScalingRules) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson320b3e1DecodeGithubComKubewardenK8sObjectsApiAutoscalingV2beta2(l, v)
}
