...
func easyjsonFe3a9659DecodeGithubComKubewardenK8sObjectsApiAutoscalingV2beta2(in *jlexer.Lexer, out *MetricValueStatus) {
...
func easyjsonFe3a9659EncodeGithubComKubewardenK8sObjectsApiAutoscalingV2beta2(out *jwriter.Writer, in MetricValueStatus) {
	out.RawByte('{')
	first := true
	_ = first
...
func (v MetricValueStatus) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonFe3a9659EncodeGithubComKubewardenK8sObjectsApiAutoscalingV2beta2(&w, v)
...
func (v *MetricValueStatus) UnmarshalJSON(data []byte) error {
	...
	easyjsonFe3a9659DecodeGithubComKubewardenK8sObjectsApiAutoscalingV2beta2(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *MetricValueStatus) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonFe3a9659DecodeGithubComKubewardenK8sObjectsApiAutoscalingV2beta2(l, v)
}
