			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjson23e3e9dcDecodeGithubComKubewardenK8sObjectsApiAutoscalingV2beta210(in, v7)
					}
		...
		out.RawString(prefix)
		{
			...
			for v8, v9 := range in.Metrics {
				...
				if v9 == nil {
					...
					easyjson23e3e9dcEncodeGithubComKubewardenK8sObjectsApiAutoscalingV2beta210(out, *v9)
				}
			}
			out.RawByte(']')
		}
...
func easyjson23e3e9dcDecodeGithubComKubewardenK8sObjectsApiAutoscalingV2beta210(in *jlexer.Lexer, out *MetricSpec) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "object":
			if in.IsNull() {
				...
				easyjson23e3e9dcDecodeGithubComKubewardenK8sObjectsApiAutoscalingV2beta211(in, out.Object)
			}
		case "pods":
			if in.IsNull() {
				in.Skip()
				...
				easyjson23e3e9dcDecodeGithubComKubewardenK8sObjectsApiAutoscalingV2beta212(in, out.Pods)
			}
		case "resource":
			if in.IsNull() {
				in.Skip()
				...
				easyjson23e3e9dcDecodeGithubComKubewardenK8sObjectsApiAutoscalingV2beta213(in, out.Resource)
			}
		case "type":
			if in.IsNull() {
				in.Skip()
...
func easyjson23e3e9dcEncodeGithubComKubewardenK8sObjectsApiAutoscalingV2beta210(out *jwriter.Writer, in MetricSpec) {
	out.RawByte('{')
	first := true
	_ = first
	if in.External != nil {
	...
	if in.Object != nil {
		...
		easyjson23e3e9dcEncodeGithubComKubewardenK8sObjectsApiAutoscalingV2beta211(out, *in.Object)
	}
	if in.Pods != nil {
		const prefix string = ",\"pods\":"
		if first {
		...
		easyjson23e3e9dcEncodeGithubComKubewardenK8sObjectsApiAutoscalingV2beta212(out, *in.Pods)
	}
	if in.Resource != nil {
		const prefix string = ",\"resource\":"
		if first {
		...
		easyjson23e3e9dcEncodeGithubComKubewardenK8sObjectsApiAutoscalingV2beta213(out, *in.Resource)
	}
	{
		const prefix string = ",\"type\":"
		if first {
...
func easyjson23e3e9dcDecodeGithubComKubewardenK8sObjectsApiAutoscalingV2beta213(in *jlexer.Lexer, out *ResourceMetricSource) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "target":
			if in.IsNull() {
				...
				easyjson23e3e9dcDecodeGithubComKubewardenK8sObjectsApiAutoscalingV2beta214(in, out.Target)
			}
		default:
			in.SkipRecursive()
		}
...
func easyjson23e3e9dcEncodeGithubComKubewardenK8sObjectsApiAutoscalingV2beta213(out *jwriter.Writer, in ResourceMetricSource) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	}
	{
		...
		if in.Target == nil {
			...
			easyjson23e3e9dcEncodeGithubComKubewardenK8sObjectsApiAutoscalingV2beta214(out, *in.Target)
		}
	}
	out.RawByte('}')
}
func easyjson23e3e9dcDecodeGithubComKubewardenK8sObjectsApiAutoscalingV2beta214(in *jlexer.Lexer, out *MetricTarget) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson23e3e9dcEncodeGithubComKubewardenK8sObjectsApiAutoscalingV2beta214(out *jwriter.Writer, in MetricTarget) {
	out.RawByte('{')
	first := true
	_ = first
	if in.AverageUtilization != 0 {
...
func easyjson23e3e9dcDecodeGithubComKubewardenK8sObjectsApiAutoscalingV2beta212(in *jlexer.Lexer, out *PodsMetricSource) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson23e3e9dcEncodeGithubComKubewardenK8sObjectsApiAutoscalingV2beta212(out *jwriter.Writer, in PodsMetricSource) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson23e3e9dcDecodeGithubComKubewardenK8sObjectsApiAutoscalingV2beta211(in *jlexer.Lexer, out *ObjectMetricSource) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson23e3e9dcEncodeGithubComKubewardenK8sObjectsApiAutoscalingV2beta211(out *jwriter.Writer, in ObjectMetricSource) {
	out.RawByte('{')
	first := true
	_ = first
	{
