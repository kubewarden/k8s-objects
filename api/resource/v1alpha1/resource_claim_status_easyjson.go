...
func easyjsonE5546390DecodeGithubComKubewardenK8sObjectsApiResourceV1alpha1(in *jlexer.Lexer, out *ResourceClaimStatus) {
...
func easyjsonE5546390EncodeGithubComKubewardenK8sObjectsApiResourceV1alpha1(out *jwriter.Writer, in ResourceClaimStatus) {
	out.RawByte('{')
	first := true
	_ = first
...
func (v ResourceClaimStatus) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonE5546390EncodeGithubComKubewardenK8sObjectsApiResourceV1alpha1(&w, v)
...
func (v *ResourceClaimStatus) UnmarshalJSON(data []byte) error {
	...
	easyjsonE5546390DecodeGithubComKubewardenK8sObjectsApiResourceV1alpha1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *ResourceClaimStatus) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonE5546390DecodeGithubComKubewardenK8sObjectsApiResourceV1alpha1(l, v)
}
