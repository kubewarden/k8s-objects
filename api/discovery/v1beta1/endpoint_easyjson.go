	...
	for !in.IsDelim('}') {
		...
		case "hints":
			if in.IsNull() {
				...
				easyjson3a9ed663DecodeGithubComKubewardenK8sObjectsApiDiscoveryV1beta12(in, out.Hints)
			}
		case "hostname":
...
func easyjson3a9ed663EncodeGithubComKubewardenK8sObjectsApiDiscoveryV1beta1(out *jwriter.Writer, in Endpoint) {
	...
	if in.Hints != nil {
		...
		out.RawString(prefix)
		easyjson3a9ed663EncodeGithubComKubewardenK8sObjectsApiDiscoveryV1beta12(out, *in.Hints)
	}
	if in.Hostname != "" {
...
func easyjson3a9ed663DecodeGithubComKubewardenK8sObjectsApiDiscoveryV1beta12(in *jlexer.Lexer, out *EndpointHints) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjson3a9ed663DecodeGithubComKubewardenK8sObjectsApiDiscoveryV1beta13(in, v6)
					}
...
func easyjson3a9ed663EncodeGithubComKubewardenK8sObjectsApiDiscoveryV1beta12(out *jwriter.Writer, in EndpointHints) {
	out.RawByte('{')
	first := true
	_ = first
	{
		...
		if in.ForZones == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v7, v8 := range in.ForZones {
				...
				if v8 == nil {
					...
					easyjson3a9ed663EncodeGithubComKubewardenK8sObjectsApiDiscoveryV1beta13(out, *v8)
				}
			}
			out.RawByte(']')
		}
...
func easyjson3a9ed663DecodeGithubComKubewardenK8sObjectsApiDiscoveryV1beta13(in *jlexer.Lexer, out *ForZone) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson3a9ed663EncodeGithubComKubewardenK8sObjectsApiDiscoveryV1beta13(out *jwriter.Writer, in ForZone) {
	out.RawByte('{')
	first := true
	_ = first
	{
