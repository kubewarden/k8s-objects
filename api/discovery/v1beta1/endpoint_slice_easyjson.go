...
func easyjsonD8856ac0DecodeGithubComKubewardenK8sObjectsApiDiscoveryV1beta1(in *jlexer.Lexer, out *EndpointSlice) {
...
func easyjsonD8856ac0EncodeGithubComKubewardenK8sObjectsApiDiscoveryV1beta1(out *jwriter.Writer, in EndpointSlice) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v EndpointSlice) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonD8856ac0EncodeGithubComKubewardenK8sObjectsApiDiscoveryV1beta1(&w, v)
...
func (v *EndpointSlice) UnmarshalJSON(data []byte) error {
	...
	easyjsonD8856ac0DecodeGithubComKubewardenK8sObjectsApiDiscoveryV1beta1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *EndpointSlice) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonD8856ac0DecodeGithubComKubewardenK8sObjectsApiDiscoveryV1beta1(l, v)
}
