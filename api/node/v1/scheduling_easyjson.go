...
func easyjsonAddc83faDecodeGithubComKubewardenK8sObjectsApiNodeV1(in *jlexer.Lexer, out *Scheduling) {
...
func easyjsonAddc83faEncodeGithubComKubewardenK8sObjectsApiNodeV1(out *jwriter.Writer, in Scheduling) {
	out.RawByte('{')
	first := true
	_ = first
...
func (v Scheduling) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonAddc83faEncodeGithubComKubewardenK8sObjectsApiNodeV1(&w, v)
...
func (v *Scheduling) UnmarshalJSON(data []byte) error {
	...
	easyjsonAddc83faDecodeGithubComKubewardenK8sObjectsApiNodeV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Scheduling) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonAddc83faDecodeGithubComKubewardenK8sObjectsApiNodeV1(l, v)
}
