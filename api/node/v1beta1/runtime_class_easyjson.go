...
func easyjson46aff27bDecodeGithubComKubewardenK8sObjectsApiNodeV1beta1(in *jlexer.Lexer, out *RuntimeClass) {
	...
	for !in.IsDelim('}') {
		...
		case "scheduling":
			if in.IsNull() {
				...
				easyjson46aff27bDecodeGithubComKubewardenK8sObjectsApiNodeV1beta11(in, out.Scheduling)
			}
		default:
			in.SkipRecursive()
		}
...
func easyjson46aff27bEncodeGithubComKubewardenK8sObjectsApiNodeV1beta1(out *jwriter.Writer, in RuntimeClass) {
	out.RawByte('{')
	first := true
	_ = first
	if in.APIVersion != "" {
	...
	if in.Scheduling != nil {
		...
		out.RawString(prefix)
		easyjson46aff27bEncodeGithubComKubewardenK8sObjectsApiNodeV1beta11(out, *in.Scheduling)
	}
	out.RawByte('}')
}
...
func (v RuntimeClass) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson46aff27bEncodeGithubComKubewardenK8sObjectsApiNodeV1beta1(&w, v)
...
func (v *RuntimeClass) UnmarshalJSON(data []byte) error {
	...
	easyjson46aff27bDecodeGithubComKubewardenK8sObjectsApiNodeV1beta1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *RuntimeClass) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson46aff27bDecodeGithubComKubewardenK8sObjectsApiNodeV1beta1(l, v)
}
func easyjson46aff27bDecodeGithubComKubewardenK8sObjectsApiNodeV1beta11(in *jlexer.Lexer, out *Scheduling) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson46aff27bEncodeGithubComKubewardenK8sObjectsApiNodeV1beta11(out *jwriter.Writer, in Scheduling) {
	out.RawByte('{')
	first := true
	_ = first
