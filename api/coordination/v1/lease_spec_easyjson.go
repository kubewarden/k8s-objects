...
func easyjsonDdb58c80DecodeGithubComKubewardenK8sObjectsApiCoordinationV1(in *jlexer.Lexer, out *LeaseSpec) {
...
func easyjsonDdb58c80EncodeGithubComKubewardenK8sObjectsApiCoordinationV1(out *jwriter.Writer, in LeaseSpec) {
	out.RawByte('{')
	first := true
	_ = first
	if true {
...
func (v LeaseSpec) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjsonDdb58c80EncodeGithubComKubewardenK8sObjectsApiCoordinationV1(&w, v)
...
func (v *LeaseSpec) UnmarshalJSON(data []byte) error {
	...
	easyjsonDdb58c80DecodeGithubComKubewardenK8sObjectsApiCoordinationV1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *LeaseSpec) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjsonDdb58c80DecodeGithubComKubewardenK8sObjectsApiCoordinationV1(l, v)
}
