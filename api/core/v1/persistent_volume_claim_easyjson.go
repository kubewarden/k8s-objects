			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjsonF52ef087DecodeGithubComKubewardenK8sObjectsApiCoreV13(in, v3)
					}
		...
		}
		{
			...
			for v7, v8 := range in.Conditions {
				...
				if v8 == nil {
					...
					easyjsonF52ef087EncodeGithubComKubewardenK8sObjectsApiCoreV13(out, *v8)
				}
			}
			out.RawByte(']')
		}
		...
		case "accessModes":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v9 string
					v9 = string(in.String())
					out.AccessModes = append(out.AccessModes, v9)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonF52ef087EncodeGithubComKubewardenK8sObjectsApiCoreV11(out *jwriter.Writer, in PersistentVolumeClaimSpec) {
	...
	if len(in.AccessModes) != 0 {
		...
		{
			out.RawByte('[')
			for v10, v11 := range in.AccessModes {
				if v10 > 0 {
					out.RawByte(',')
				}
		...
		case "limits":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					key := string(in.String())
					in.WantColon()
					var v12 *resource.Quantity
					if in.IsNull() {
						in.Skip()
						v12 = nil
					} else {
						if v12 == nil {
							v12 = new(resource.Quantity)
						}
						*v12 = resource.Quantity(in.String())
					}
					(out.Limits)[key] = v12
					in.WantComma()
				}
		...
		case "requests":
			if in.IsNull() {
				...
				for !in.IsDelim('}') {
					key := string(in.String())
					in.WantColon()
					var v13 *resource.Quantity
					if in.IsNull() {
						in.Skip()
						v13 = nil
					} else {
						if v13 == nil {
							v13 = new(resource.Quantity)
						}
						*v13 = resource.Quantity(in.String())
					}
					(out.Requests)[key] = v13
					in.WantComma()
				}
				in.Delim('}')
			}
...
func easyjsonF52ef087EncodeGithubComKubewardenK8sObjectsApiCoreV15(out *jwriter.Writer, in ResourceRequirements) {
	...
	if len(in.Limits) != 0 {
		...
		out.RawString(prefix[1:])
		{
			out.RawByte('{')
			v14First := true
			for v14Name, v14Value := range in.Limits {
				if v14First {
					v14First = false
				} else {
					out.RawByte(',')
	...
	if len(in.Requests) != 0 {
		...
		}
		{
			out.RawByte('{')
			v15First := true
			for v15Name, v15Value := range in.Requests {
				if v15First {
					v15First = false
				} else {
					out.RawByte(',')
