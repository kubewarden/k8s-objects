	...
	for !in.IsDelim('}') {
		...
		case "windowsOptions":
			if in.IsNull() {
				...
				easyjson853a9577DecodeGithubComKubewardenK8sObjectsApiCoreV18(in, out.WindowsOptions)
			}
		default:
			in.SkipRecursive()
		}
...
func easyjson853a9577EncodeGithubComKubewardenK8sObjectsApiCoreV14(out *jwriter.Writer, in SecurityContext) {
	...
	if in.WindowsOptions != nil {
		...
		easyjson853a9577EncodeGithubComKubewardenK8sObjectsApiCoreV18(out, *in.WindowsOptions)
	}
	out.RawByte('}')
}
func easyjson853a9577DecodeGithubComKubewardenK8sObjectsApiCoreV18(in *jlexer.Lexer, out *WindowsSecurityContextOptions) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson853a9577EncodeGithubComKubewardenK8sObjectsApiCoreV18(out *jwriter.Writer, in WindowsSecurityContextOptions) {
	out.RawByte('{')
	first := true
	_ = first
	...
	for !in.IsDelim('}') {
		...
		case "exec":
			if in.IsNull() {
				...
				easyjson853a9577DecodeGithubComKubewardenK8sObjectsApiCoreV19(in, out.Exec)
			}
		...
		case "httpGet":
			if in.IsNull() {
				...
				easyjson853a9577DecodeGithubComKubewardenK8sObjectsApiCoreV110(in, out.HTTPGet)
			}
		...
		case "tcpSocket":
			if in.IsNull() {
				...
				easyjson853a9577DecodeGithubComKubewardenK8sObjectsApiCoreV111(in, out.TCPSocket)
			}
		case "timeoutSeconds":
...
func easyjson853a9577EncodeGithubComKubewardenK8sObjectsApiCoreV12(out *jwriter.Writer, in Probe) {
	...
	if in.Exec != nil {
		...
		first = false
		out.RawString(prefix[1:])
		easyjson853a9577EncodeGithubComKubewardenK8sObjectsApiCoreV19(out, *in.Exec)
	}
	...
	if in.HTTPGet != nil {
		...
		easyjson853a9577EncodeGithubComKubewardenK8sObjectsApiCoreV110(out, *in.HTTPGet)
	}
	...
	if in.TCPSocket != nil {
		...
		easyjson853a9577EncodeGithubComKubewardenK8sObjectsApiCoreV111(out, *in.TCPSocket)
	}
...
func easyjson853a9577DecodeGithubComKubewardenK8sObjectsApiCoreV111(in *jlexer.Lexer, out *TCPSocketAction) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson853a9577EncodeGithubComKubewardenK8sObjectsApiCoreV111(out *jwriter.Writer, in TCPSocketAction) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Host != "" {
...
func easyjson853a9577DecodeGithubComKubewardenK8sObjectsApiCoreV110(in *jlexer.Lexer, out *HTTPGetAction) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjson853a9577DecodeGithubComKubewardenK8sObjectsApiCoreV112(in, v26)
					}
...
func easyjson853a9577EncodeGithubComKubewardenK8sObjectsApiCoreV110(out *jwriter.Writer, in HTTPGetAction) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Host != "" {
		...
		if in.HTTPHeaders == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v27, v28 := range in.HTTPHeaders {
				...
				if v28 == nil {
					...
					easyjson853a9577EncodeGithubComKubewardenK8sObjectsApiCoreV112(out, *v28)
				}
			}
			out.RawByte(']')
		}
...
func easyjson853a9577DecodeGithubComKubewardenK8sObjectsApiCoreV112(in *jlexer.Lexer, out *HTTPHeader) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson853a9577EncodeGithubComKubewardenK8sObjectsApiCoreV112(out *jwriter.Writer, in HTTPHeader) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson853a9577DecodeGithubComKubewardenK8sObjectsApiCoreV19(in *jlexer.Lexer, out *ExecAction) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson853a9577EncodeGithubComKubewardenK8sObjectsApiCoreV19(out *jwriter.Writer, in ExecAction) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	for !in.IsDelim('}') {
		...
		case "postStart":
			if in.IsNull() {
				...
				easyjson853a9577DecodeGithubComKubewardenK8sObjectsApiCoreV113(in, out.PostStart)
			}
		case "preStop":
			if in.IsNull() {
				in.Skip()
				...
				easyjson853a9577DecodeGithubComKubewardenK8sObjectsApiCoreV113(in, out.PreStop)
			}
		default:
			in.SkipRecursive()
		}
...
func easyjson853a9577EncodeGithubComKubewardenK8sObjectsApiCoreV11(out *jwriter.Writer, in Lifecycle) {
	...
	if in.PostStart != nil {
		...
		first = false
		out.RawString(prefix[1:])
		easyjson853a9577EncodeGithubComKubewardenK8sObjectsApiCoreV113(out, *in.PostStart)
	}
	if in.PreStop != nil {
		...
		easyjson853a9577EncodeGithubComKubewardenK8sObjectsApiCoreV113(out, *in.PreStop)
	}
	out.RawByte('}')
}
func easyjson853a9577DecodeGithubComKubewardenK8sObjectsApiCoreV113(in *jlexer.Lexer, out *Handler) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson853a9577EncodeGithubComKubewardenK8sObjectsApiCoreV113(out *jwriter.Writer, in Handler) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Exec != nil {
