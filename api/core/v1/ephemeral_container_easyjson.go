	...
	for !in.IsDelim('}') {
		...
		case "httpGet":
			if in.IsNull() {
				...
				easyjson853a9577DecodeGithubComKubewardenK8sObjectsApiCoreV111(in, out.HTTPGet)
			}
		...
		case "tcpSocket":
			if in.IsNull() {
				...
				easyjson853a9577DecodeGithubComKubewardenK8sObjectsApiCoreV112(in, out.TCPSocket)
			}
...
func easyjson853a9577EncodeGithubComKubewardenK8sObjectsApiCoreV12(out *jwriter.Writer, in Probe) {
	...
	if in.HTTPGet != nil {
		...
		easyjson853a9577EncodeGithubComKubewardenK8sObjectsApiCoreV111(out, *in.HTTPGet)
	}
	...
	if in.TCPSocket != nil {
		...
		easyjson853a9577EncodeGithubComKubewardenK8sObjectsApiCoreV112(out, *in.TCPSocket)
	}
...
func easyjson853a9577DecodeGithubComKubewardenK8sObjectsApiCoreV112(in *jlexer.Lexer, out *TCPSocketAction) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson853a9577EncodeGithubComKubewardenK8sObjectsApiCoreV112(out *jwriter.Writer, in TCPSocketAction) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Host != "" {
...
func easyjson853a9577DecodeGithubComKubewardenK8sObjectsApiCoreV111(in *jlexer.Lexer, out *HTTPGetAction) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjson853a9577DecodeGithubComKubewardenK8sObjectsApiCoreV113(in, v26)
					}
...
func easyjson853a9577EncodeGithubComKubewardenK8sObjectsApiCoreV111(out *jwriter.Writer, in HTTPGetAction) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Host != "" {
		...
		}
		{
			...
			for v27, v28 := range in.HTTPHeaders {
				...
				if v28 == nil {
					...
					easyjson853a9577EncodeGithubComKubewardenK8sObjectsApiCoreV113(out, *v28)
				}
			}
			out.RawByte(']')
		}
...
func easyjson853a9577DecodeGithubComKubewardenK8sObjectsApiCoreV113(in *jlexer.Lexer, out *HTTPHeader) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson853a9577EncodeGithubComKubewardenK8sObjectsApiCoreV113(out *jwriter.Writer, in HTTPHeader) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	for !in.IsDelim('}') {
		...
		case "postStart":
			if in.IsNull() {
				...
				easyjson853a9577DecodeGithubComKubewardenK8sObjectsApiCoreV114(in, out.PostStart)
			}
		case "preStop":
			if in.IsNull() {
				in.Skip()
				...
				easyjson853a9577DecodeGithubComKubewardenK8sObjectsApiCoreV114(in, out.PreStop)
			}
		default:
			in.SkipRecursive()
		}
...
func easyjson853a9577EncodeGithubComKubewardenK8sObjectsApiCoreV11(out *jwriter.Writer, in Lifecycle) {
	...
	if in.PostStart != nil {
		...
		first = false
		out.RawString(prefix[1:])
		easyjson853a9577EncodeGithubComKubewardenK8sObjectsApiCoreV114(out, *in.PostStart)
	}
	if in.PreStop != nil {
		...
		easyjson853a9577EncodeGithubComKubewardenK8sObjectsApiCoreV114(out, *in.PreStop)
	}
	out.RawByte('}')
}
func easyjson853a9577DecodeGithubComKubewardenK8sObjectsApiCoreV114(in *jlexer.Lexer, out *Handler) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson853a9577EncodeGithubComKubewardenK8sObjectsApiCoreV114(out *jwriter.Writer, in Handler) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Exec != nil {
