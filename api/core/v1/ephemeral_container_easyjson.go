			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjson853a9577DecodeGithubComKubewardenK8sObjectsApiCoreV15(in, v7)
					}
			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjson853a9577DecodeGithubComKubewardenK8sObjectsApiCoreV16(in, v8)
					}
		...
		out.RawString(prefix)
		{
			...
			for v21, v22 := range in.VolumeDevices {
				...
				if v22 == nil {
					...
					easyjson853a9577EncodeGithubComKubewardenK8sObjectsApiCoreV15(out, *v22)
				}
			}
			out.RawByte(']')
		}
		...
		out.RawString(prefix)
		{
			...
			for v23, v24 := range in.VolumeMounts {
				...
				if v24 == nil {
					...
					easyjson853a9577EncodeGithubComKubewardenK8sObjectsApiCoreV16(out, *v24)
				}
			}
			out.RawByte(']')
		}
			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjson853a9577DecodeGithubComKubewardenK8sObjectsApiCoreV110(in, v25)
					}
		...
		out.RawString(prefix[1:])
		{
			...
			for v28, v29 := range in.Claims {
				...
				if v29 == nil {
					...
					easyjson853a9577EncodeGithubComKubewardenK8sObjectsApiCoreV110(out, *v29)
				}
			}
			out.RawByte(']')
		}
			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjson853a9577DecodeGithubComKubewardenK8sObjectsApiCoreV115(in, v32)
					}
		...
		}
		{
			...
			for v33, v34 := range in.HTTPHeaders {
				...
				if v34 == nil {
					...
					easyjson853a9577EncodeGithubComKubewardenK8sObjectsApiCoreV115(out, *v34)
				}
			}
			out.RawByte(']')
		}
