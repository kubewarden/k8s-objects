	...
	for !in.IsDelim('}') {
		...
		case "hostAliases":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.HostAliases = append(out.HostAliases, v2)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "imagePullSecrets":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v3 *LocalObjectReference
					if in.IsNull() {
						in.Skip()
						v3 = nil
					} else {
						if v3 == nil {
							v3 = new(LocalObjectReference)
						}
						(*v3).UnmarshalEasyJSON(in)
					}
					out.ImagePullSecrets = append(out.ImagePullSecrets, v3)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "initContainers":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.InitContainers = append(out.InitContainers, v4)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "readinessGates":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v6 *PodReadinessGate
					if in.IsNull() {
						in.Skip()
						v6 = nil
					} else {
						if v6 == nil {
							v6 = new(PodReadinessGate)
						}
						(*v6).UnmarshalEasyJSON(in)
					}
					out.ReadinessGates = append(out.ReadinessGates, v6)
					in.WantComma()
				}
				in.Delim(']')
			}
			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjsonA34d1d2dDecodeGithubComKubewardenK8sObjectsApiCoreV11(in, v7)
					}
					out.Tolerations = append(out.Tolerations, v7)
					in.WantComma()
				}
				in.Delim(']')
			}
			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjsonA34d1d2dDecodeGithubComKubewardenK8sObjectsApiCoreV12(in, v8)
					}
					out.Volumes = append(out.Volumes, v8)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonA34d1d2dEncodeGithubComKubewardenK8sObjectsApiCoreV1(out *jwriter.Writer, in PodSpec) {
	...
	}
	{
		...
		if in.Containers == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			out.RawByte('[')
			for v9, v10 := range in.Containers {
				if v9 > 0 {
					out.RawByte(',')
				}
				if v10 == nil {
	...
	if len(in.HostAliases) != 0 {
		...
		{
			out.RawByte('[')
			for v11, v12 := range in.HostAliases {
				if v11 > 0 {
					out.RawByte(',')
				}
				if v12 == nil {
	...
	if len(in.ImagePullSecrets) != 0 {
		...
		{
			out.RawByte('[')
			for v13, v14 := range in.ImagePullSecrets {
				if v13 > 0 {
					out.RawByte(',')
				}
				if v14 == nil {
	...
	if len(in.InitContainers) != 0 {
		...
		{
			out.RawByte('[')
			for v15, v16 := range in.InitContainers {
				if v15 > 0 {
					out.RawByte(',')
				}
				if v16 == nil {
	...
	if len(in.ReadinessGates) != 0 {
		...
		{
			out.RawByte('[')
			for v18, v19 := range in.ReadinessGates {
				if v18 > 0 {
					out.RawByte(',')
				}
				if v19 == nil {
	...
	if len(in.Tolerations) != 0 {
		...
		{
			out.RawByte('[')
			for v20, v21 := range in.Tolerations {
				if v20 > 0 {
					out.RawByte(',')
				}
				if v21 == nil {
					...
					easyjsonA34d1d2dEncodeGithubComKubewardenK8sObjectsApiCoreV11(out, *v21)
				}
			}
			out.RawByte(']')
		}
		...
		out.RawString(prefix)
		{
			...
			for v22, v23 := range in.Volumes {
				...
				if v23 == nil {
					...
					easyjsonA34d1d2dEncodeGithubComKubewardenK8sObjectsApiCoreV12(out, *v23)
				}
			}
			out.RawByte(']')
		}
...
func easyjsonA34d1d2dDecodeGithubComKubewardenK8sObjectsApiCoreV12(in *jlexer.Lexer, out *Volume) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "portworxVolume":
			if in.IsNull() {
				...
				easyjsonA34d1d2dDecodeGithubComKubewardenK8sObjectsApiCoreV13(in, out.PortworxVolume)
			}
		case "projected":
			if in.IsNull() {
				in.Skip()
				...
				easyjsonA34d1d2dDecodeGithubComKubewardenK8sObjectsApiCoreV14(in, out.Projected)
			}
		case "quobyte":
			if in.IsNull() {
				in.Skip()
				...
				easyjsonA34d1d2dDecodeGithubComKubewardenK8sObjectsApiCoreV15(in, out.Quobyte)
			}
		case "rbd":
			if in.IsNull() {
				in.Skip()
		...
		case "scaleIO":
			if in.IsNull() {
				...
				easyjsonA34d1d2dDecodeGithubComKubewardenK8sObjectsApiCoreV17(in, out.ScaleIO)
			}
		case "secret":
			if in.IsNull() {
				in.Skip()
				...
				easyjsonA34d1d2dDecodeGithubComKubewardenK8sObjectsApiCoreV18(in, out.Secret)
			}
		case "storageos":
			if in.IsNull() {
				in.Skip()
				...
				easyjsonA34d1d2dDecodeGithubComKubewardenK8sObjectsApiCoreV19(in, out.Storageos)
			}
		case "vsphereVolume":
			if in.IsNull() {
				in.Skip()
				...
				easyjsonA34d1d2dDecodeGithubComKubewardenK8sObjectsApiCoreV110(in, out.VsphereVolume)
			}
		default:
			in.SkipRecursive()
		}
...
func easyjsonA34d1d2dEncodeGithubComKubewardenK8sObjectsApiCoreV12(out *jwriter.Writer, in Volume) {
	out.RawByte('{')
	first := true
	_ = first
	...
	if in.PortworxVolume != nil {
		...
		out.RawString(prefix)
		easyjsonA34d1d2dEncodeGithubComKubewardenK8sObjectsApiCoreV13(out, *in.PortworxVolume)
	}
	if in.Projected != nil {
		const prefix string = ",\"projected\":"
		out.RawString(prefix)
		easyjsonA34d1d2dEncodeGithubComKubewardenK8sObjectsApiCoreV14(out, *in.Projected)
	}
	if in.Quobyte != nil {
	...
	if in.ScaleIO != nil {
		...
		out.RawString(prefix)
		easyjsonA34d1d2dEncodeGithubComKubewardenK8sObjectsApiCoreV17(out, *in.ScaleIO)
	}
	if in.Secret != nil {
		const prefix string = ",\"secret\":"
		out.RawString(prefix)
		easyjsonA34d1d2dEncodeGithubComKubewardenK8sObjectsApiCoreV18(out, *in.Secret)
	}
	if in.Storageos != nil {
		const prefix string = ",\"storageos\":"
		out.RawString(prefix)
		easyjsonA34d1d2dEncodeGithubComKubewardenK8sObjectsApiCoreV19(out, *in.Storageos)
	}
	if in.VsphereVolume != nil {
		const prefix string = ",\"vsphereVolume\":"
		out.RawString(prefix)
		easyjsonA34d1d2dEncodeGithubComKubewardenK8sObjectsApiCoreV110(out, *in.VsphereVolume)
	}
	out.RawByte('}')
}
func easyjsonA34d1d2dDecodeGithubComKubewardenK8sObjectsApiCoreV110(in *jlexer.Lexer, out *VsphereVirtualDiskVolumeSource) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonA34d1d2dEncodeGithubComKubewardenK8sObjectsApiCoreV110(out *jwriter.Writer, in VsphereVirtualDiskVolumeSource) {
	out.RawByte('{')
	first := true
	_ = first
	if in.FsType != "" {
...
func easyjsonA34d1d2dDecodeGithubComKubewardenK8sObjectsApiCoreV19(in *jlexer.Lexer, out *StorageOSVolumeSource) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonA34d1d2dEncodeGithubComKubewardenK8sObjectsApiCoreV19(out *jwriter.Writer, in StorageOSVolumeSource) {
	out.RawByte('{')
	first := true
	_ = first
	if in.FsType != "" {
...
func easyjsonA34d1d2dDecodeGithubComKubewardenK8sObjectsApiCoreV18(in *jlexer.Lexer, out *SecretVolumeSource) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonA34d1d2dEncodeGithubComKubewardenK8sObjectsApiCoreV18(out *jwriter.Writer, in SecretVolumeSource) {
	out.RawByte('{')
	first := true
	_ = first
	if in.DefaultMode != 0 {
...
func easyjsonA34d1d2dDecodeGithubComKubewardenK8sObjectsApiCoreV17(in *jlexer.Lexer, out *ScaleIOVolumeSource) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonA34d1d2dEncodeGithubComKubewardenK8sObjectsApiCoreV17(out *jwriter.Writer, in ScaleIOVolumeSource) {
	out.RawByte('{')
	first := true
	_ = first
	if in.FsType != "" {
...
func easyjsonA34d1d2dDecodeGithubComKubewardenK8sObjectsApiCoreV16(in *jlexer.Lexer, out *RBDVolumeSource) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "monitors":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Monitors = append(out.Monitors, v27)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonA34d1d2dEncodeGithubComKubewardenK8sObjectsApiCoreV16(out *jwriter.Writer, in RBDVolumeSource) {
	out.RawByte('{')
	first := true
	_ = first
	if in.FsType != "" {
...
func easyjsonA34d1d2dDecodeGithubComKubewardenK8sObjectsApiCoreV15(in *jlexer.Lexer, out *QuobyteVolumeSource) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonA34d1d2dEncodeGithubComKubewardenK8sObjectsApiCoreV15(out *jwriter.Writer, in QuobyteVolumeSource) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Group != "" {
...
func easyjsonA34d1d2dDecodeGithubComKubewardenK8sObjectsApiCoreV14(in *jlexer.Lexer, out *ProjectedVolumeSource) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "sources":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v30 *VolumeProjection
					if in.IsNull() {
						in.Skip()
						v30 = nil
					} else {
						if v30 == nil {
							v30 = new(VolumeProjection)
						}
						easyjsonA34d1d2dDecodeGithubComKubewardenK8sObjectsApiCoreV111(in, v30)
					}
					out.Sources = append(out.Sources, v30)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonA34d1d2dEncodeGithubComKubewardenK8sObjectsApiCoreV14(out *jwriter.Writer, in ProjectedVolumeSource) {
	out.RawByte('{')
	first := true
	_ = first
	if in.DefaultMode != 0 {
		...
		if in.Sources == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v31, v32 := range in.Sources {
				...
				if v32 == nil {
					...
					easyjsonA34d1d2dEncodeGithubComKubewardenK8sObjectsApiCoreV111(out, *v32)
				}
			}
			out.RawByte(']')
		}
...
func easyjsonA34d1d2dDecodeGithubComKubewardenK8sObjectsApiCoreV111(in *jlexer.Lexer, out *VolumeProjection) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "secret":
			if in.IsNull() {
				...
				easyjsonA34d1d2dDecodeGithubComKubewardenK8sObjectsApiCoreV112(in, out.Secret)
			}
		case "serviceAccountToken":
			if in.IsNull() {
				...
				easyjsonA34d1d2dDecodeGithubComKubewardenK8sObjectsApiCoreV113(in, out.ServiceAccountToken)
			}
		default:
			in.SkipRecursive()
		}
...
func easyjsonA34d1d2dEncodeGithubComKubewardenK8sObjectsApiCoreV111(out *jwriter.Writer, in VolumeProjection) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ConfigMap != nil {
	...
	if in.Secret != nil {
		...
		easyjsonA34d1d2dEncodeGithubComKubewardenK8sObjectsApiCoreV112(out, *in.Secret)
	}
	if in.ServiceAccountToken != nil {
		...
		easyjsonA34d1d2dEncodeGithubComKubewardenK8sObjectsApiCoreV113(out, *in.ServiceAccountToken)
	}
	out.RawByte('}')
}
func easyjsonA34d1d2dDecodeGithubComKubewardenK8sObjectsApiCoreV113(in *jlexer.Lexer, out *ServiceAccountTokenProjection) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonA34d1d2dEncodeGithubComKubewardenK8sObjectsApiCoreV113(out *jwriter.Writer, in ServiceAccountTokenProjection) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Audience != "" {
...
func easyjsonA34d1d2dDecodeGithubComKubewardenK8sObjectsApiCoreV112(in *jlexer.Lexer, out *SecretProjection) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonA34d1d2dEncodeGithubComKubewardenK8sObjectsApiCoreV112(out *jwriter.Writer, in SecretProjection) {
	out.RawByte('{')
	first := true
	_ = first
	if len(in.Items) != 0 {
...
func easyjsonA34d1d2dDecodeGithubComKubewardenK8sObjectsApiCoreV13(in *jlexer.Lexer, out *PortworxVolumeSource) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonA34d1d2dEncodeGithubComKubewardenK8sObjectsApiCoreV13(out *jwriter.Writer, in PortworxVolumeSource) {
	out.RawByte('{')
	first := true
	_ = first
	if in.FsType != "" {
