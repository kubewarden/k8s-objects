	...
	for !in.IsDelim('}') {
			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjson6769e492DecodeGithubComKubewardenK8sObjectsApiCoreV12(in, v2)
					}
		...
		case "windowsOptions":
			if in.IsNull() {
				...
				easyjson6769e492DecodeGithubComKubewardenK8sObjectsApiCoreV13(in, out.WindowsOptions)
			}
		default:
			in.SkipRecursive()
		}
...
func easyjson6769e492EncodeGithubComKubewardenK8sObjectsApiCoreV1(out *jwriter.Writer, in PodSecurityContext) {
		...
		}
		{
			...
			for v5, v6 := range in.Sysctls {
				...
				if v6 == nil {
					...
					easyjson6769e492EncodeGithubComKubewardenK8sObjectsApiCoreV12(out, *v6)
				}
			}
			out.RawByte(']')
		}
	...
	if in.WindowsOptions != nil {
		...
		easyjson6769e492EncodeGithubComKubewardenK8sObjectsApiCoreV13(out, *in.WindowsOptions)
	}
	out.RawByte('}')
}
...
func easyjson6769e492DecodeGithubComKubewardenK8sObjectsApiCoreV13(in *jlexer.Lexer, out *WindowsSecurityContextOptions) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6769e492EncodeGithubComKubewardenK8sObjectsApiCoreV13(out *jwriter.Writer, in WindowsSecurityContextOptions) {
	out.RawByte('{')
	first := true
	_ = first
...
func easyjson6769e492DecodeGithubComKubewardenK8sObjectsApiCoreV12(in *jlexer.Lexer, out *Sysctl) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson6769e492EncodeGithubComKubewardenK8sObjectsApiCoreV12(out *jwriter.Writer, in Sysctl) {
	out.RawByte('{')
	first := true
	_ = first
	{
