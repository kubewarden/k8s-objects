		...
		case "matchLabelKeys":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.MatchLabelKeys = append(out.MatchLabelKeys, v59)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV110(out *jwriter.Writer, in TopologySpreadConstraint) {
	...
	if len(in.MatchLabelKeys) != 0 {
		...
		{
			out.RawByte('[')
			for v60, v61 := range in.MatchLabelKeys {
				if v60 > 0 {
					out.RawByte(',')
				}
		...
		case "supplementalGroups":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v62 int64
					v62 = int64(in.Int64())
					out.SupplementalGroups = append(out.SupplementalGroups, v62)
					in.WantComma()
				}
				in.Delim(']')
			}
			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV125(in, v63)
					}
					out.Sysctls = append(out.Sysctls, v63)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV18(out *jwriter.Writer, in PodSecurityContext) {
	...
	if len(in.SupplementalGroups) != 0 {
		...
		{
			out.RawByte('[')
			for v64, v65 := range in.SupplementalGroups {
				if v64 > 0 {
					out.RawByte(',')
				}
				out.Int64(int64(v65))
		...
		}
		{
			...
			for v66, v67 := range in.Sysctls {
				...
				if v67 == nil {
					...
					easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV125(out, *v67)
				}
			}
			out.RawByte(']')
		}
	...
	for !in.IsDelim('}') {
		...
		case "nameservers":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Nameservers = append(out.Nameservers, v68)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "options":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v69 *PodDNSConfigOption
					if in.IsNull() {
						in.Skip()
						v69 = nil
					} else {
						if v69 == nil {
							v69 = new(PodDNSConfigOption)
						}
						easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV127(in, v69)
					}
					out.Options = append(out.Options, v69)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "searches":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Searches = append(out.Searches, v70)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV15(out *jwriter.Writer, in PodDNSConfig) {
	...
	if len(in.Nameservers) != 0 {
		...
		{
			out.RawByte('[')
			for v71, v72 := range in.Nameservers {
				if v71 > 0 {
					out.RawByte(',')
				}
		...
		}
		{
			...
			for v73, v74 := range in.Options {
				...
				if v74 == nil {
					...
					easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV127(out, *v74)
				}
			}
			out.RawByte(']')
		}
