		...
		case "initContainerStatuses":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.InitContainerStatuses = append(out.InitContainerStatuses, v3)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV12(out *jwriter.Writer, in PodStatus) {
		...
		out.RawString(prefix[1:])
		{
			...
			for v4, v5 := range in.Conditions {
				...
				if v5 == nil {
					...
					easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV13(out, *v5)
				}
			}
			out.RawByte(']')
		}
	...
	if len(in.ContainerStatuses) != 0 {
		...
		{
			out.RawByte('[')
			for v6, v7 := range in.ContainerStatuses {
				if v6 > 0 {
					out.RawByte(',')
				}
				if v7 == nil {
	...
	if len(in.InitContainerStatuses) != 0 {
		...
		{
			out.RawByte('[')
			for v8, v9 := range in.InitContainerStatuses {
				if v8 > 0 {
					out.RawByte(',')
				}
				if v9 == nil {
	...
	for !in.IsDelim('}') {
		...
		case "containers":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Containers = append(out.Containers, v10)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "dnsConfig":
			if in.IsNull() {
				...
				easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV14(in, out.DNSConfig)
			}
		case "dnsPolicy":
		...
		case "hostAliases":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.HostAliases = append(out.HostAliases, v11)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "imagePullSecrets":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v12 *LocalObjectReference
					if in.IsNull() {
						in.Skip()
						v12 = nil
					} else {
						if v12 == nil {
							v12 = new(LocalObjectReference)
						}
						(*v12).UnmarshalEasyJSON(in)
					}
					out.ImagePullSecrets = append(out.ImagePullSecrets, v12)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "initContainers":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.InitContainers = append(out.InitContainers, v13)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "readinessGates":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v15 *PodReadinessGate
					if in.IsNull() {
						in.Skip()
						v15 = nil
					} else {
						if v15 == nil {
							v15 = new(PodReadinessGate)
						}
						easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV15(in, v15)
					}
					out.ReadinessGates = append(out.ReadinessGates, v15)
					in.WantComma()
				}
				in.Delim(']')
			}
		...
		case "securityContext":
			if in.IsNull() {
				...
				easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV16(in, out.SecurityContext)
			}
		case "serviceAccount":
			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV17(in, v16)
					}
					out.Tolerations = append(out.Tolerations, v16)
					in.WantComma()
				}
				in.Delim(']')
			}
			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV18(in, v17)
					}
					out.Volumes = append(out.Volumes, v17)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV11(out *jwriter.Writer, in PodSpec) {
	...
	if in.DNSConfig != nil {
		...
		out.RawString(prefix)
		easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV14(out, *in.DNSConfig)
	}
	if in.DNSPolicy != "" {
	...
	if len(in.HostAliases) != 0 {
		...
		{
			out.RawByte('[')
			for v20, v21 := range in.HostAliases {
				if v20 > 0 {
					out.RawByte(',')
				}
				if v21 == nil {
	...
	if len(in.ImagePullSecrets) != 0 {
		...
		{
			out.RawByte('[')
			for v22, v23 := range in.ImagePullSecrets {
				if v22 > 0 {
					out.RawByte(',')
				}
				if v23 == nil {
	...
	if len(in.InitContainers) != 0 {
		...
		{
			out.RawByte('[')
			for v24, v25 := range in.InitContainers {
				if v24 > 0 {
					out.RawByte(',')
				}
				if v25 == nil {
	...
	if len(in.NodeSelector) != 0 {
		...
		out.RawString(prefix)
		{
			out.RawByte('{')
			v26First := true
			for v26Name, v26Value := range in.NodeSelector {
				if v26First {
					v26First = false
				} else {
					out.RawByte(',')
	...
	if len(in.ReadinessGates) != 0 {
		...
		{
			out.RawByte('[')
			for v27, v28 := range in.ReadinessGates {
				if v27 > 0 {
					out.RawByte(',')
				}
				if v28 == nil {
					...
					easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV15(out, *v28)
				}
			}
			out.RawByte(']')
		}
	...
	if in.SecurityContext != nil {
		...
		out.RawString(prefix)
		easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV16(out, *in.SecurityContext)
	}
	...
	if len(in.Tolerations) != 0 {
		...
		{
			out.RawByte('[')
			for v29, v30 := range in.Tolerations {
				if v29 > 0 {
					out.RawByte(',')
				}
				if v30 == nil {
					...
					easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV17(out, *v30)
				}
			}
			out.RawByte(']')
		}
		...
		out.RawString(prefix)
		{
			...
			for v31, v32 := range in.Volumes {
				...
				if v32 == nil {
					...
					easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV18(out, *v32)
				}
			}
			out.RawByte(']')
		}
...
func easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV18(in *jlexer.Lexer, out *Volume) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "portworxVolume":
			if in.IsNull() {
				...
				easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV19(in, out.PortworxVolume)
			}
		case "projected":
			if in.IsNull() {
				in.Skip()
				...
				easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV110(in, out.Projected)
			}
		case "quobyte":
			if in.IsNull() {
				in.Skip()
				...
				easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV111(in, out.Quobyte)
			}
		case "rbd":
			if in.IsNull() {
				in.Skip()
				...
				easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV112(in, out.Rbd)
			}
		case "scaleIO":
			if in.IsNull() {
				in.Skip()
				...
				easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV113(in, out.ScaleIO)
			}
		case "secret":
			if in.IsNull() {
				in.Skip()
				...
				easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV114(in, out.Secret)
			}
		case "storageos":
			if in.IsNull() {
				in.Skip()
				...
				easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV115(in, out.Storageos)
			}
		case "vsphereVolume":
			if in.IsNull() {
				in.Skip()
				...
				easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV116(in, out.VsphereVolume)
			}
		default:
			in.SkipRecursive()
		}
...
func easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV18(out *jwriter.Writer, in Volume) {
	out.RawByte('{')
	first := true
	_ = first
	...
	if in.PortworxVolume != nil {
		...
		out.RawString(prefix)
		easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV19(out, *in.PortworxVolume)
	}
	if in.Projected != nil {
		const prefix string = ",\"projected\":"
		out.RawString(prefix)
		easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV110(out, *in.Projected)
	}
	if in.Quobyte != nil {
		const prefix string = ",\"quobyte\":"
		out.RawString(prefix)
		easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV111(out, *in.Quobyte)
	}
	if in.Rbd != nil {
		const prefix string = ",\"rbd\":"
		out.RawString(prefix)
		easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV112(out, *in.Rbd)
	}
	if in.ScaleIO != nil {
		const prefix string = ",\"scaleIO\":"
		out.RawString(prefix)
		easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV113(out, *in.ScaleIO)
	}
	if in.Secret != nil {
		const prefix string = ",\"secret\":"
		out.RawString(prefix)
		easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV114(out, *in.Secret)
	}
	if in.Storageos != nil {
		const prefix string = ",\"storageos\":"
		out.RawString(prefix)
		easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV115(out, *in.Storageos)
	}
	if in.VsphereVolume != nil {
		const prefix string = ",\"vsphereVolume\":"
		out.RawString(prefix)
		easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV116(out, *in.VsphereVolume)
	}
	out.RawByte('}')
}
func easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV116(in *jlexer.Lexer, out *VsphereVirtualDiskVolumeSource) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV116(out *jwriter.Writer, in VsphereVirtualDiskVolumeSource) {
	out.RawByte('{')
	first := true
	_ = first
	if in.FsType != "" {
...
func easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV115(in *jlexer.Lexer, out *StorageOSVolumeSource) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV115(out *jwriter.Writer, in StorageOSVolumeSource) {
	out.RawByte('{')
	first := true
	_ = first
	if in.FsType != "" {
...
func easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV114(in *jlexer.Lexer, out *SecretVolumeSource) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "items":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Items = append(out.Items, v33)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV114(out *jwriter.Writer, in SecretVolumeSource) {
	out.RawByte('{')
	first := true
	_ = first
	if in.DefaultMode != 0 {
...
func easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV113(in *jlexer.Lexer, out *ScaleIOVolumeSource) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV113(out *jwriter.Writer, in ScaleIOVolumeSource) {
	out.RawByte('{')
	first := true
	_ = first
	if in.FsType != "" {
...
func easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV112(in *jlexer.Lexer, out *RBDVolumeSource) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "monitors":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Monitors = append(out.Monitors, v36)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV112(out *jwriter.Writer, in RBDVolumeSource) {
	out.RawByte('{')
	first := true
	_ = first
	if in.FsType != "" {
...
func easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV111(in *jlexer.Lexer, out *QuobyteVolumeSource) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV111(out *jwriter.Writer, in QuobyteVolumeSource) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Group != "" {
...
func easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV110(in *jlexer.Lexer, out *ProjectedVolumeSource) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "sources":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v39 *VolumeProjection
					if in.IsNull() {
						in.Skip()
						v39 = nil
					} else {
						if v39 == nil {
							v39 = new(VolumeProjection)
						}
						easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV117(in, v39)
					}
					out.Sources = append(out.Sources, v39)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV110(out *jwriter.Writer, in ProjectedVolumeSource) {
	out.RawByte('{')
	first := true
	_ = first
	if in.DefaultMode != 0 {
		...
		if in.Sources == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v40, v41 := range in.Sources {
				...
				if v41 == nil {
					...
					easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV117(out, *v41)
				}
			}
			out.RawByte(']')
		}
...
func easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV117(in *jlexer.Lexer, out *VolumeProjection) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "secret":
			if in.IsNull() {
				...
				easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV118(in, out.Secret)
			}
		case "serviceAccountToken":
			if in.IsNull() {
				...
				easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV119(in, out.ServiceAccountToken)
			}
		default:
			in.SkipRecursive()
		}
...
func easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV117(out *jwriter.Writer, in VolumeProjection) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ConfigMap != nil {
	...
	if in.Secret != nil {
		...
		easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV118(out, *in.Secret)
	}
	if in.ServiceAccountToken != nil {
		...
		easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV119(out, *in.ServiceAccountToken)
	}
	out.RawByte('}')
}
func easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV119(in *jlexer.Lexer, out *ServiceAccountTokenProjection) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV119(out *jwriter.Writer, in ServiceAccountTokenProjection) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Audience != "" {
...
func easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV118(in *jlexer.Lexer, out *SecretProjection) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
		...
		case "items":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Items = append(out.Items, v42)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV118(out *jwriter.Writer, in SecretProjection) {
	out.RawByte('{')
	first := true
	_ = first
	if len(in.Items) != 0 {
...
func easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV19(in *jlexer.Lexer, out *PortworxVolumeSource) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV19(out *jwriter.Writer, in PortworxVolumeSource) {
	out.RawByte('{')
	first := true
	_ = first
	if in.FsType != "" {
...
func easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV17(in *jlexer.Lexer, out *Toleration) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV17(out *jwriter.Writer, in Toleration) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Effect != "" {
...
func easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV16(in *jlexer.Lexer, out *PodSecurityContext) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "seLinuxOptions":
			if in.IsNull() {
				...
				easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV120(in, out.SeLinuxOptions)
			}
		case "supplementalGroups":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v45 int64
					v45 = int64(in.Int64())
					out.SupplementalGroups = append(out.SupplementalGroups, v45)
					in.WantComma()
				}
				in.Delim(']')
			}
			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV121(in, v46)
					}
					out.Sysctls = append(out.Sysctls, v46)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "windowsOptions":
			if in.IsNull() {
				...
				easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV122(in, out.WindowsOptions)
			}
		default:
			in.SkipRecursive()
		}
...
func easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV16(out *jwriter.Writer, in PodSecurityContext) {
	out.RawByte('{')
	first := true
	_ = first
	if in.FsGroup != 0 {
	...
	if in.SeLinuxOptions != nil {
		...
		easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV120(out, *in.SeLinuxOptions)
	}
	if len(in.SupplementalGroups) != 0 {
		...
		{
			out.RawByte('[')
			for v47, v48 := range in.SupplementalGroups {
				if v47 > 0 {
					out.RawByte(',')
				}
				out.Int64(int64(v48))
		...
		}
		{
			...
			for v49, v50 := range in.Sysctls {
				...
				if v50 == nil {
					...
					easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV121(out, *v50)
				}
			}
			out.RawByte(']')
		}
	...
	if in.WindowsOptions != nil {
		...
		easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV122(out, *in.WindowsOptions)
	}
	out.RawByte('}')
}
func easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV122(in *jlexer.Lexer, out *WindowsSecurityContextOptions) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV122(out *jwriter.Writer, in WindowsSecurityContextOptions) {
	out.RawByte('{')
	first := true
	_ = first
...
func easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV121(in *jlexer.Lexer, out *Sysctl) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV121(out *jwriter.Writer, in Sysctl) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV120(in *jlexer.Lexer, out *SELinuxOptions) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV120(out *jwriter.Writer, in SELinuxOptions) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Level != "" {
...
func easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV15(in *jlexer.Lexer, out *PodReadinessGate) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV15(out *jwriter.Writer, in PodReadinessGate) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV14(in *jlexer.Lexer, out *PodDNSConfig) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "nameservers":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Nameservers = append(out.Nameservers, v51)
					in.WantComma()
				}
				in.Delim(']')
			}
		case "options":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v52 *PodDNSConfigOption
					if in.IsNull() {
						in.Skip()
						v52 = nil
					} else {
						if v52 == nil {
							v52 = new(PodDNSConfigOption)
						}
						easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV123(in, v52)
					}
		...
		case "searches":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					out.Searches = append(out.Searches, v53)
					in.WantComma()
				}
				in.Delim(']')
			}
...
func easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV14(out *jwriter.Writer, in PodDNSConfig) {
	out.RawByte('{')
	first := true
	_ = first
	if len(in.Nameservers) != 0 {
		...
		{
			out.RawByte('[')
			for v54, v55 := range in.Nameservers {
				if v54 > 0 {
					out.RawByte(',')
				}
		...
		}
		{
			...
			for v56, v57 := range in.Options {
				...
				if v57 == nil {
					...
					easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV123(out, *v57)
				}
			}
			out.RawByte(']')
		}
...
func easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV123(in *jlexer.Lexer, out *PodDNSConfigOption) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV123(out *jwriter.Writer, in PodDNSConfigOption) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Name != "" {
