	...
	for !in.IsDelim('}') {
			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV123(in, v60)
					}
		...
		case "windowsOptions":
			if in.IsNull() {
				...
				easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV124(in, out.WindowsOptions)
			}
		default:
			in.SkipRecursive()
		}
...
func easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV17(out *jwriter.Writer, in PodSecurityContext) {
		...
		if in.Sysctls == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v63, v64 := range in.Sysctls {
				...
				if v64 == nil {
					...
					easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV123(out, *v64)
				}
			}
			out.RawByte(']')
		}
	...
	if in.WindowsOptions != nil {
		...
		out.RawString(prefix)
		easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV124(out, *in.WindowsOptions)
	}
	out.RawByte('}')
}
func easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV124(in *jlexer.Lexer, out *WindowsSecurityContextOptions) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV124(out *jwriter.Writer, in WindowsSecurityContextOptions) {
	out.RawByte('{')
	first := true
	_ = first
...
func easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV123(in *jlexer.Lexer, out *Sysctl) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV123(out *jwriter.Writer, in Sysctl) {
	out.RawByte('{')
	first := true
	_ = first
	{
			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV125(in, v66)
					}
		...
		if in.Options == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v70, v71 := range in.Options {
				...
				if v71 == nil {
					...
					easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV125(out, *v71)
				}
			}
			out.RawByte(']')
		}
...
func easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV125(in *jlexer.Lexer, out *PodDNSConfigOption) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV125(out *jwriter.Writer, in PodDNSConfigOption) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Name != "" {
