			...
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					...
					if in.IsNull() {
						...
						easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV122(in, v52)
					}
		...
		if in.Options == nil && (out.Flags&jwriter.NilSliceAsEmpty) == 0 {
			...
			for v56, v57 := range in.Options {
				...
				if v57 == nil {
					...
					easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV122(out, *v57)
				}
			}
			out.RawByte(']')
		}
...
func easyjsonBe091417DecodeGithubComKubewardenK8sObjectsApiCoreV122(in *jlexer.Lexer, out *PodDNSConfigOption) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjsonBe091417EncodeGithubComKubewardenK8sObjectsApiCoreV122(out *jwriter.Writer, in PodDNSConfigOption) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Name != "" {
